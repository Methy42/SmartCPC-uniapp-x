...
open class GenPagesCSSFlexFlexBasis : BasePage {
        ...
        return _cE("view", _uM("style" to _nS(_uM("flex-grow" to "1"))), _uA(
            _cE("view", null, _uA(
                ...
                _cE("view", _uM("style" to _nS(_uM("width" to "250px", "height" to "150px", "background-color" to "gray", "flex-direction" to "row"))), _uA(
                    _cE("view", _uM("class" to "common", "style" to _nS(_uM("flex-basis" to "150px"))), _uA(
                        _cE("text", null, "150px")
                    ), 4),
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("common" to _pS(_uM("width" to 50, "height" to 50, "backgroundColor" to "#FF0000", "justifyContent" to "center", "alignItems" to "center")))
            }
