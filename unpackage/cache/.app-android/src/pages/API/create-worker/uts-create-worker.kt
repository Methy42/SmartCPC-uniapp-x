    ...
    companion object {
        ...
        var setup: (__props: GenPagesAPICreateWorkerUtsCreateWorker, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            fun addLog(message: String, type: String = "info") {
                ...
                val logItem: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("logItem", "pages/API/create-worker/uts-create-worker.uvue", 62, 11), "message" to ("[" + timeStr + "] " + message), "type" to type, "time" to timeStr)
            ...
            fun gen_create_fn() {
                ...
                onWorkerMessage(UTSWorkerAddListenerOptions(success = fun(res: Any){
                    val result = (UTSAndroid.consoleDebugError(JSON.parse(JSON.stringify(res)), " at pages/API/create-worker/uts-create-worker.uvue:84") as UTSJSONObject).getAny("result") as UTSJSONObject
