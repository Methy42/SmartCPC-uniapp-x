...
open class GenPagesAPIDialogPageDialogTextarea : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return _cE("view", _uM("class" to "dialog-container"), _uA(
            _cE("view", _uM("class" to "dialog-content"), _uA(
                ...
                _cE("textarea", _uM("class" to "dialog-textarea", "placeholder" to "输入框..."))
            ))
        ))
    }
