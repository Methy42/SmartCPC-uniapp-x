...
const _cache = this.$.renderCache
  return _cE("view", _uM({
    ref: _ctx.elId,
    class: "block",
    style: _nS(_uM({width:_ctx.size+'px',height:_ctx.size+'px'}))
  }), null, 4 /* STYLE */)
}
const GenUniModulesUniLoadingComponentsUniLoadingLoadingCircleStyles = [_uM([["block", _pS(_uM([["width", 50], ["height", 50]]))]])]
