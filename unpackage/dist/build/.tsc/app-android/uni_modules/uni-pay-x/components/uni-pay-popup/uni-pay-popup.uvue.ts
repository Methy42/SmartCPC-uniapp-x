...
const _cache = this.$.renderCache
  return isTrue(_ctx.isOpen)
    ? withDirectives(_cE("view", _uM({
        key: 0,
        class: _nC(["popup-root", 'popup-'+_ctx.type]),
...
const GenUniModulesUniPayXComponentsUniPayPopupUniPayPopupStyles = [_uM([["popup-root", _pS(_uM([["position", "fixed"], ["top", 0], ["left", 0], ["width", "100%"], ["height", "100%"], ["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["backgroundColor", "rgba(0,0,0,0.4)"], ["justifyContent", "center"], ["alignItems", "center"], ["zIndex", 99]]))], ["popup-box", _pS(_uM([["width", "100%"], ["justifyContent", "center"], ["alignItems", "center"]]))], ["popup-bottom", _pS(_uM([["justifyContent", "flex-end"]]))]])]
