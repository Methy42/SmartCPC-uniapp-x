...
export const pages = [
	...
	{
		path: "pages/meeting/meetingList",
		style: {
...
export const subPackages = [
	...
	},
	{
		...
		pages: [
			...
			{
				path: "border/issues-23230",
				style: {
					navigationBarTitleText: "issues-23230"
				}
			},
			{
...
export const tabBar = {
	...
	list: [
		...
		{
			pagePath: "pages/meeting/meetingList",
			text: "三会一课",
			iconPath: "static/tab/meeting.png",
			selectedIconPath: "static/tab/meeting-active.png",
			badge: "4"
		},
		{
		...
		},
		{
			...
			text: "统计",
			iconPath: "static/tab/statistics.png",
			selectedIconPath: "static/tab/statistics-active.png"
		},
		{
