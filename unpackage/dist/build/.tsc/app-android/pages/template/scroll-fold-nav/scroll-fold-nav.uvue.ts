  ...
  return _cE("scroll-view", _uM({
    ...
    _cE("view", _uM({ class: "content" }), [
      _cE("view", _uM({ class: "content-item" }), [
        _cE("text", _uM({ class: "text" }), "1. 当前示例监听了 scroll-view 的 scroll 事件 ，滚动页面实时监听scrollTop。"),
        _cE("text", _uM({ class: "text" }), "2. 使用 ref 直接获取元素的节点，并在 scroll 事件中通过节点的 setProperty 方法来修改搜索导航栏的高度、位置和背景颜色等样式，从而达到滚动折叠的效果。"),
        _cE("text", _uM({ class: "text" }), "3. 请向上\\向下滚动页面观察效果。")
      ]),
      _cE(Fragment, null, RenderHelpers.renderList(20, (item, index, __index, _cached): any => {
        return _cE("view", _uM({
          class: "content-item",
          key: index
        }), [
          _cE("text", _uM({ class: "text" }), "content-" + _tD(item), 1 /* TEXT */)
        ])
      }), 64 /* STABLE_FRAGMENT */)
    ]),
    _cE("view", _uM({
      ...
      _cE("view", _uM({
        ...
        _cE("text", _uM({ class: "searchinput" }), "请输入你要搜索的内容"),
        _cE("text", _uM({ class: "searchbutton" }), "搜索")
      ], 8 /* PROPS */, ["onClick"])
    ], 512 /* NEED_PATCH */)
  ], 40 /* PROPS, NEED_HYDRATION */, ["onScroll"])
}
const GenPagesTemplateScrollFoldNavScrollFoldNavStyles = [_uM([["page", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["backgroundColor", "#f5f5f5"]]))], ["navigatorbar", _pS(_uM([["position", "fixed"], ["paddingTop", 35], ["height", 124], ["borderBottomWidth", 1], ["borderBottomStyle", "solid"], ["borderBottomColor", "#efefef"], ["width", "100%"], ["backgroundColor", "#f5f5f5"]]))], ["titlebar", _pS(_uM([["flexDirection", "row"], ["alignItems", "center"], ["height", 44]]))], ["backview", _pS(_uM([["width", 44], ["height", 44], ["justifyContent", "center"], ["alignItems", "center"]]))], ["back", _pS(_uM([["width", 20]]))], ["title", _pS(_uM([["marginTop", 0], ["marginRight", 2], ["marginBottom", 0], ["marginLeft", 2]]))], ["searchbar", _pS(_uM([["position", "absolute"], ["bottom", 2], ["left", 0], ["right", 0], ["backgroundColor", "#FFFFFF"], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#fbdf0d"], ["borderRightColor", "#fbdf0d"], ["borderBottomColor", "#fbdf0d"], ["borderLeftColor", "#fbdf0d"], ["height", 32], ["borderTopLeftRadius", 100], ["borderTopRightRadius", 100], ["borderBottomRightRadius", 100], ["borderBottomLeftRadius", 100], ["marginTop", 6], ["marginRight", 12], ["marginBottom", 6], ["marginLeft", 12], ["paddingTop", 8], ["paddingRight", 8], ["paddingBottom", 8], ["paddingLeft", 8], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "center"]]))], ["searchimg", _pS(_uM([["width", 15]]))], ["searchinput", _pS(_uM([["flexGrow", 1], ["fontSize", 12], ["color", "#666666"]]))], ["searchbutton", _pS(_uM([["fontSize", 12], ["backgroundColor", "#ff6900"], ["color", "#FFFFFF"], ["paddingTop", 5], ["paddingRight", 8], ["paddingBottom", 5], ["paddingLeft", 8], ["borderTopLeftRadius", 100], ["borderTopRightRadius", 100], ["borderBottomRightRadius", 100], ["borderBottomLeftRadius", 100]]))], ["seatbar", _pS(_uM([["height", 124]]))], ["content", _pS(_uM([["paddingTop", 5], ["paddingRight", 15], ["paddingBottom", 5], ["paddingLeft", 15]]))], ["content-item", _pS(_uM([["paddingTop", 15], ["paddingRight", 15], ["paddingBottom", 15], ["paddingLeft", 15], ["marginTop", 5], ["marginRight", 0], ["marginBottom", 5], ["marginLeft", 0], ["backgroundColor", "#ffffff"], ["borderTopLeftRadius", 5], ["borderTopRightRadius", 5], ["borderBottomRightRadius", 5], ["borderBottomLeftRadius", 5]]))], ["text", _pS(_uM([["fontSize", 14], ["color", "#666666"], ["lineHeight", "20px"]]))]])]
