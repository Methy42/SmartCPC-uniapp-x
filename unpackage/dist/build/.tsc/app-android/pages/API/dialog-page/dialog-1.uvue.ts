...
const _cache = this.$.renderCache
  return _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "dialog-content" }), [
      ...
      _cE("text", _uM({ class: "mt-10" }), "onBackPress return true"),
      _cE("button", _uM({
        class: "mt-10",
...
const GenPagesAPIDialogPageDialog1Styles = [_uM([["dialog-container", _pS(_uM([["width", "100%"], ["height", "100%"], ["backgroundColor", "rgba(0,0,0,0.3)"], ["display", "flex"], ["justifyContent", "center"], ["alignItems", "center"]]))], ["dialog-content", _pS(_uM([["width", "80%"], ["paddingTop", 10], ["paddingRight", 10], ["paddingBottom", 10], ["paddingLeft", 10], ["backgroundColor", "#ffffff"], ["borderTopLeftRadius", 6], ["borderTopRightRadius", 6], ["borderBottomRightRadius", 6], ["borderBottomLeftRadius", 6]]))], ["mt-10", _pS(_uM([["marginTop", 10]]))]])]
