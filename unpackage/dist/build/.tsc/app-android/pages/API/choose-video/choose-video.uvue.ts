  ...
  return _cE("scroll-view", _uM({
    ...
    _cE("view", _uM({ class: "uni-padding-wrap" }), [
      ...
      _cE("view", _uM({ class: "uni-title" }), [
        _cE("text", _uM({ class: "uni-subtitle-text" }), "视频信息")
      ]),
      _cE("text", null, _tD(_ctx.videoInfo), 1 /* TEXT */),
...
const GenPagesAPIChooseVideoChooseVideoStyles = [_uM([["video", _pS(_uM([["alignSelf", "center"], ["width", 300], ["height", 225]]))]])]
