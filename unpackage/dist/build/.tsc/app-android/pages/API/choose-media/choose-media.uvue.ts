      ...
      _cE("view", _uM({ class: "uni-common-mt" }), [
        _cE("view", _uM({ class: "uni-list" }), [
          _cE("view", _uM({ class: "uni-list-cell cell-pd" }), [
            _cE("view", _uM({ class: "uni-list-cell-left uni-label" }), " 来源 "),
            _cE("view", _uM({
              class: "uni-list-cell-right",
              onClick: _ctx.chooseMediaSource
            }), [
              _cE("text", _uM({ class: "click-t" }), _tD(_ctx.sourceTypes[_ctx.sourceTypeIndex].title), 1 /* TEXT */)
            ], 8 /* PROPS */, ["onClick"])
          ]),
          _cE("view", _uM({ class: "uni-list-cell cell-pd" }), [
            _cE("view", _uM({ class: "uni-list-cell-left uni-label" }), " 方式 "),
            _cE("view", _uM({
              class: "uni-list-cell-right",
              onClick: _ctx.chooseMediaType
            }), [
              _cE("text", _uM({ class: "click-t" }), _tD((_ctx.mediaTypes[_ctx.mediaTypeIndex] as ChooseSource).title), 1 /* TEXT */)
            ], 8 /* PROPS */, ["onClick"])
          ]),
          _cE("view", _uM({ class: "uni-list-cell cell-pd" }), [
            _cE("view", _uM({ class: "uni-list-cell-left uni-label" }), " 数量限制 "),
          ...
          _cE("view", _uM({ class: "uni-list-cell cell-pd" }), [
            _cE("view", _uM({ class: "uni-list-cell-left uni-label" }), " 屏幕方向 "),
            _cE("view", _uM({
              class: "uni-list-cell-right",
              onClick: _ctx.chooseOrientationType
            }), [
              _cE("text", _uM({ class: "click-t" }), _tD(_ctx.orientationTypes[_ctx.orientationTypeIndex].title), 1 /* TEXT */)
            ], 8 /* PROPS */, ["onClick"])
          ]),
          _cE("view", _uM({ class: "uni-list-cell cell-pd" }), [
            _cE("view", _uM({ class: "uni-list-cell-left uni-label" }), " 摄像头 "),
            _cE("view", _uM({
              class: "uni-list-cell-right",
              onClick: _ctx.chooseCameraType
            }), [
              _cE("text", _uM({ class: "click-t" }), _tD(_ctx.cameraTypes[_ctx.cameraTypeIndex].title), 1 /* TEXT */)
            ], 8 /* PROPS */, ["onClick"])
          ])
        ]),
        _cE("view", _uM({
          ...
          _cE("view", _uM({
            ...
            _cE("view", _uM({ class: "uni-list-cell-left" }), "点击预览"),
            _cE("view", _uM({
              style: _nS(_uM({"margin-left":"auto"}))
            }), [
              _cE("text", _uM({ class: "click-t" }), _tD(_ctx.mediaList.length) + "/" + _tD(_ctx.count), 1 /* TEXT */)
            ], 4 /* STYLE */)
          ], 4 /* STYLE */),
          _cE("view", _uM({
            class: "uni-flex",
            ...
            _cE(Fragment, null, RenderHelpers.renderList(_ctx.mediaList, (file, index, __index, _cached): any => {
              return _cE("view", _uM({
                key: index,
