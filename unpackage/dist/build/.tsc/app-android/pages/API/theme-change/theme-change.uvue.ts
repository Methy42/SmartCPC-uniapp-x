...
const _component_radio_group = resolveComponent("radio-group")
  ...
  return _cE("view", _uM({ class: "uni-padding-wrap" }), [
    _cE("view", _uM({ class: "uni-common-mt item-box" }), [
      _cE("text", null, "osTheme:"),
      _cE("text", _uM({ id: "theme" }), _tD(_ctx.osTheme), 1 /* TEXT */)
    ]),
    _cE("view", _uM({ class: "uni-common-mt item-box" }), [
      _cE("text", null, "应用当前主题:"),
      _cE("text", _uM({ id: "theme" }), _tD(_ctx.appTheme), 1 /* TEXT */)
    ]),
    _cE("view", null, [
      _cE("view", _uM({ class: "uni-title uni-common-mt" }), [
        _cE("text", _uM({ class: "uni-title-text" }), " 修改appTheme主题（此处仅为演示API，本应用并未完整适配暗黑模式） ")
      ])
    ]),
        ...
        default: withSlotCtx((): any[] => [
          _cE(Fragment, null, RenderHelpers.renderList(_ctx.items, (item, index, __index, _cached): any => {
            return _cV(_component_radio, _uM({
              class: _nC(["uni-list-cell uni-list-cell-pd radio", index < _ctx.items.length - 1 ? 'uni-list-cell-line' : '']),
              key: item,
              value: item,
...
const GenPagesAPIThemeChangeThemeChangeStyles = [_uM([["item-box", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["justifyContent", "space-between"]]))], ["uni-list-cell", _pS(_uM([["justifyContent", "flex-start"]]))]])]
