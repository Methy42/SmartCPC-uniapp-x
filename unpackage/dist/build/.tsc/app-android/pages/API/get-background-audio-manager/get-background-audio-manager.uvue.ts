...
const _component_slider = resolveComponent("slider")
  ...
  return _cE("view", null, [
    ...
    _cE("view", _uM({ class: "uni-padding-wrap" }), [
      ...
      _cE("view", _uM({ class: "page-body-buttons" }), [
        isTrue(_ctx.playing)
        ...
        isTrue(!_ctx.playing)
          ...
          : _cC("v-if", true),
        _cE("view", _uM({ class: "page-body-button" }))
      ])
    ])
  ])
}
const GenPagesAPIGetBackgroundAudioManagerGetBackgroundAudioManagerStyles = [_uM([["image", _pS(_uM([["width", 75], ["height", 75]]))], ["page-body-text", _pS(_uM([["paddingTop", 0], ["paddingRight", 15], ["paddingBottom", 0], ["paddingLeft", 15]]))], ["page-body-wrapper", _pS(_uM([["marginTop", 0]]))], ["page-body-info", _pS(_uM([["paddingBottom", 25]]))], ["time-big", _pS(_uM([["fontSize", 30], ["marginTop", 10], ["marginRight", 10], ["marginBottom", 10], ["marginLeft", 10]]))], ["slider", _pS(_uM([["width", 315]]))], ["play-time", _pS(_uM([["width", "100%"], ["paddingTop", 10], ["paddingRight", 0], ["paddingBottom", 10], ["paddingLeft", 0], ["display", "flex"], ["justifyContent", "space-between"], ["boxSizing", "border-box"]]))], ["page-body-buttons", _pS(_uM([["display", "flex"], ["justifyContent", "center"], ["marginTop", 50], ["flexDirection", "column"]]))], ["page-body-button", _pS(_uM([["flexDirection", "row"], ["justifyContent", "center"]]))]])]
