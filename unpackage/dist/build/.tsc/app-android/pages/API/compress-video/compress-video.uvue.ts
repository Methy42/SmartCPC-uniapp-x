    ...
    _cE("view", null, [
      _cE("view", _uM({ class: "uni-padding-wrap" }), [
        ...
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-subtitle-text" }), "压缩前视频信息")
        ]),
        _cE("text", null, _tD(_ctx.beforeCompressVideoInfo), 1 /* TEXT */),
        _cE("video", _uM({
          class: "video",
        ...
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-subtitle-text" }), "压缩后视频信息")
        ]),
        _cE("text", null, _tD(_ctx.afterCompressVideoInfo), 1 /* TEXT */),
        ...
        _cE("view", _uM({ class: "uni-common-mt" }), [
          _cE("text", _uM({ class: "uni-title uni-title-text" }), "相对于原视频的分辨率比例，取值范围(0, 1]"),
...
const GenPagesAPICompressVideoCompressVideoStyles = [_uM([["video", _pS(_uM([["alignSelf", "center"]]))], ["image-container", _pS(_uM([["flexDirection", "row"]]))]])]
