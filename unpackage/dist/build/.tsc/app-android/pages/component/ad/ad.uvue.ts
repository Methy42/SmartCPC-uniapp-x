...
const _component_page_head = resolveEasyComponent("page-head",_easycom_page_head)
  ...
  return _cE("view", null, [
    _cV(_component_page_head, _uM({ title: "信息流广告" })),
    _cE("ad", _uM({
      adpid: "1111111111",
    ...
    isTrue(_ctx.tips)
      ...
      : _cC("v-if", true),
    _cE("button", _uM({ onClick: _ctx.pushList }), "列表-信息流", 8 /* PROPS */, ["onClick"]),
    _cE("button", _uM({ onClick: _ctx.pushVideoAd }), "视频贴片-非全屏", 8 /* PROPS */, ["onClick"]),
    _cE("button", _uM({ onClick: _ctx.pushVideoAdL }), "视频贴片-横向全屏", 8 /* PROPS */, ["onClick"]),
    _cE("button", _uM({ onClick: _ctx.pushVideoAdP }), "视频贴片-竖向全屏", 8 /* PROPS */, ["onClick"])
  ])
}
