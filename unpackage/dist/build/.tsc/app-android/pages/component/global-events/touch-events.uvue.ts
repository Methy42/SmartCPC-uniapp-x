...
const _component_navigator = resolveComponent("navigator")
  ...
  return _cE("scroll-view", _uM({
    ...
    _cV(_component_page_head, _uM({ title: "拖拽图标测试相关事件(在小程序上本示例会卡顿,小程序上应使用movable-view)" })),
    _cE("view", _uM({
      class: "uni-padding-wrap uni-common-mt",
      style: _nS(_uM({"bottom":"20px"}))
    }), [
      _cV(_component_navigator, _uM({
        ...
        default: withSlotCtx((): any[] => [
          _cE("button", _uM({ type: "default" }), " stopPropagation / preventDefault ")
        ]),
        _: 1 /* STABLE */
      }))
    ], 4 /* STYLE */),
    ...
    _ctx.touchEvent !== null
      ? _cE("view", _uM({ key: 0 }), [
          _cE("text", _uM({ class: "title1" }), "touches: "),
          _cE(Fragment, null, RenderHelpers.renderList(_ctx.touchEvent!.touches, (touch, index, __index, _cached): any => {
            return _cE(Fragment, _uM({ key: index }), [
              _cE("text", _uM({ class: "title2" }), "touch[" + _tD(index) + "]:", 1 /* TEXT */),
              _cE("text", null, "identifier: " + _tD(touch.identifier), 1 /* TEXT */),
              _cE("text", null, "pageX: " + _tD(touch.pageX) + ", pageY: " + _tD(touch.pageY), 1 /* TEXT */),
              _cE("text", null, "clientX: " + _tD(touch.clientX) + ", clientY: " + _tD(touch.clientY), 1 /* TEXT */),
              _cE("text", null, "screenX: " + _tD(touch.screenX) + ", screenY: " + _tD(touch.screenY), 1 /* TEXT */)
            ], 64 /* STABLE_FRAGMENT */)
          }), 128 /* KEYED_FRAGMENT */)
        ])
      : _cC("v-if", true)
...
const GenPagesComponentGlobalEventsTouchEventsStyles = [_uM([["container", _pS(_uM([["width", "100%"], ["flexDirection", "column"], ["alignItems", "center"]]))], ["view-box", _pS(_uM([["width", 300], ["height", 300], ["alignItems", "center"], ["justifyContent", "center"], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"]]))], ["icon", _pS(_uM([["width", 100], ["height", 100]]))], ["title1", _pS(_uM([["marginTop", 10], ["fontSize", 18]]))], ["title2", _pS(_uM([["marginTop", 5], ["fontSize", 16]]))]])]
