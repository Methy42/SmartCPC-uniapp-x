  ...
  return _cE(Fragment, null, [
    _cE("view", _uM({ class: "main" }), [
      _cE("waterflow", _uM({
        ...
        onClick: [_ctx.waterflow_click, _ctx.waterflow_tap] as Array<any | null>,
        ...
        _cE(Fragment, null, RenderHelpers.renderList(_ctx.scrollData, (item, index, __index, _cached): any => {
          return _cE("flow-item", _uM({
            key: index,
            id: item.text,
            onClick: [_ctx.flow_item_click, _ctx.flow_item_tap] as Array<any | null>,
            style: _nS(_uM({'height' : item.height})),
        ...
        withDirectives(_cE("flow-item", _uM({
          slot: "load-more",
          id: "loadmore",
          type: "6",
          class: "load-more-box"
    ...
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({ class: "content" }), [
        ...
        _cV(_component_navigator, _uM({ url: "/pages/component/waterflow/waterflow-fit-height" }), _uM({
...
const GenPagesComponentWaterflowWaterflowStyles = [_uM([["main", _pS(_uM([["maxHeight", 250], ["paddingTop", 5], ["paddingRight", 0], ["paddingBottom", 5], ["paddingLeft", 0], ["borderBottomWidth", 1], ["borderBottomStyle", "solid"], ["borderBottomColor", "rgba(0,0,0,0.06)"], ["flexDirection", "row"], ["justifyContent", "center"]]))], ["flow-item", _pS(_uM([["width", "100%"], ["height", 200], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#666666"], ["borderRightColor", "#666666"], ["borderBottomColor", "#666666"], ["borderLeftColor", "#666666"], ["backgroundColor", "#66ccff"], ["alignItems", "center"], ["justifyContent", "center"]]))], ["tip-text", _pS(_uM([["color", "#888888"], ["fontSize", 12]]))], ["refresh-box", _pS(_uM([["justifyContent", "center"], ["alignItems", "center"], ["flexDirection", "row"], ["height", 45], ["width", "100%"]]))], ["load-more-box", _pS(_uM([["justifyContent", "center"], ["alignItems", "center"], ["flexDirection", "row"], ["height", 45], ["width", "100%"], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"]]))], ["button", _pS(_uM([["marginTop", 15]]))]])]
