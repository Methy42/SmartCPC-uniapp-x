...
const _component_enum_data = resolveEasyComponent("enum-data",_easycom_enum_data)
  ...
  return _cE(Fragment, null, [
    _cV(_component_page_head, _uM({ title: "view" })),
    _cE("view", _uM({
      id: "view",
      class: "main",
      ...
      _cE("view", _uM({
        id: "view-child1",
        class: _nC(["test-view", _ctx.isDarkMode ? 'theme-dark' : 'theme-light']),
...
const GenPagesComponentViewViewStyles = [_uM([["main", _pS(_uM([["paddingTop", 5], ["paddingRight", 0], ["paddingBottom", 5], ["paddingLeft", 0], ["flexDirection", "row"], ["justifyContent", "center"]]))], ["test-view", _pS(_uM([["height", 200], ["width", 200], ["backgroundColor", "var(--list-background-color,#ffffff)"]]))], ["is-hover", _pS(_uM([["backgroundColor", "#179b16"]]))], ["is-parent-hover", _pS(_uM([["backgroundColor", "#aa0000"]]))]])]
