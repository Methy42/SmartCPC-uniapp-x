...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "page-body" }), [
    _cE("canvas", _uM({
      id: "canvas",
      class: "canvas"
    })),
    _cE("text", _uM({ class: "fps" }), "FPS: " + _tD(unref(fpsString)), 1 /* TEXT */),
    _cE("view", _uM({ class: "item" }), [
      _cE("text", _uM({ class: "item-label" }), "Speed"),
      _cE("button", _uM({
        size: "mini",
        onClick: () => {unref(lessClick)('speed')}
      }), "-", 8 /* PROPS */, ["onClick"]),
      _cE("text", _uM({ class: "item-value" }), _tD(unref(ballSpeed)), 1 /* TEXT */),
      _cE("button", _uM({
        size: "mini",
    ...
    _cE("view", _uM({ class: "item" }), [
      _cE("text", _uM({ class: "item-label" }), "Layer"),
      _cE("button", _uM({
        size: "mini",
        onClick: () => {unref(lessClick)('layer')}
      }), "-", 8 /* PROPS */, ["onClick"]),
      _cE("text", _uM({ class: "item-value" }), _tD(unref(ballLayer)), 1 /* TEXT */),
      _cE("button", _uM({
        size: "mini",
    ...
    _cE("view", _uM({ class: "item" }), [
      _cE("text", _uM({ class: "item-label" }), "Inlayer"),
      _cE("button", _uM({
        size: "mini",
        onClick: () => {unref(lessClick)('inLayer')}
      }), "-", 8 /* PROPS */, ["onClick"]),
      _cE("text", _uM({ class: "item-value" }), _tD(unref(ballInlayer)), 1 /* TEXT */),
      _cE("button", _uM({
        size: "mini",
...
const GenPagesComponentCanvasCanvasBallStyles = [_uM([["page-body-wrapper", _pS(_uM([["textAlign", "center"]]))], ["page-body", _pS(_uM([["paddingTop", 15], ["paddingRight", 15], ["paddingBottom", 15], ["paddingLeft", 15]]))], ["canvas", _pS(_uM([["width", 300], ["height", 300], ["marginTop", "auto"], ["marginRight", "auto"], ["marginBottom", "auto"], ["marginLeft", "auto"], ["backgroundColor", "#ffffff"]]))], ["fps", _pS(_uM([["marginTop", 30], ["marginBottom", 20]]))], ["item", _pS(_uM([["flexDirection", "row"], ["alignItems", "center"], ["marginTop", 10]]))], ["item-label", _pS(_uM([["marginRight", "auto"]]))], ["item-value", _pS(_uM([["color", "#6495ED"], ["width", 50], ["textAlign", "center"]]))]])]
