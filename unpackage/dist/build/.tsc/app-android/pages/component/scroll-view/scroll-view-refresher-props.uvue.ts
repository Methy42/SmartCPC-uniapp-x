...
const _component_switch = resolveComponent("switch")
  ...
  return _cE("view", _uM({ class: "page-scroll-view" }), [
    _cV(_component_page_head, _uM({ title: "下拉刷新的scroll-view属性示例" })),
    _cE("view", _uM({ class: "uni-margin-wrap" }), [
      _cE("scroll-view", _uM({
        direction: "vertical",
    ...
    _cE("scroll-view", _uM({
      class: "uni-list",
      style: _nS(_uM({"padding-top":"16px"})),
      showScrollbar: true
    }), [
      _cE("view", _uM({ class: "uni-list-cell-padding" }), [
        _cE("text", _uM({ class: "refresher-tips" }), "**下拉刷新的属性设置需要先打开下拉刷新开关**")
      ]),
      ...
      _cE("view", _uM({ class: "uni-list-cell-padding" }), [
        ...
        _cE("view", _uM({ class: "switch-refresher-group" }), [
          _cE("button", _uM({
...
const GenPagesComponentScrollViewScrollViewRefresherPropsStyles = [_uM([["uni-margin-wrap", _pS(_uM([["height", 200], ["marginTop", 0], ["marginRight", 25], ["marginBottom", 25], ["marginLeft", 25]]))], ["item", _pS(_uM([["justifyContent", "center"], ["alignItems", "center"], ["height", 200], ["width", "100%"], ["backgroundColor", "#F0FFFF"], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#D2691E"], ["borderRightColor", "#D2691E"], ["borderBottomColor", "#D2691E"], ["borderLeftColor", "#D2691E"]]))], ["refresher-tips", _pS(_uM([["fontSize", 12], ["textAlign", "center"], ["color", "#FF0000"]]))], ["uni-text", _pS(_uM([["color", "#000000"], ["fontSize", 50]]))], ["uni-list", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["uni-list-cell-input", _pS(_uM([["maxWidth", 100], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#cccccc"], ["borderRightColor", "#cccccc"], ["borderBottomColor", "#cccccc"], ["borderLeftColor", "#cccccc"], ["textAlign", "center"]]))], ["switch-refresher-group", _pS(_uM([["flexDirection", "row"], ["marginTop", 5]]))], ["switch-refresher-style", _pS(_uM([["paddingTop", 2], ["paddingRight", 10], ["paddingBottom", 2], ["paddingLeft", 10], ["marginRight", 5]]))]])]
