...
const _component_refresh_box = resolveComponent("refresh-box")
  ...
  return _cE("view", _uM({
    style: _nS(_uM({"overflow":"visible","flex":"1"}))
  }), [
    _cV(_component_page_head, _uM({ title: "list-view 下拉刷新" })),
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({
        style: _nS(_uM({"height":"25px"}))
      }), null, 4 /* STYLE */),
      _cE(Fragment, null, RenderHelpers.renderList(_ctx.listCount, (i, __key, __index, _cached): any => {
