  ...
  return _cE(Fragment, null, [
    _cE("view", _uM({ class: "main" }), [
      _cE("list-view", _uM({
        ...
        onClick: [_ctx.list_view_click, _ctx.list_view_tap] as Array<any | null>,
        ...
        _cE(Fragment, null, RenderHelpers.renderList(_ctx.scrollData, (key, __key, __index, _cached): any => {
          return _cE("list-item", _uM({
            key: key,
            id: key,
            onClick: [_ctx.list_item_click, _ctx.list_item_tap] as Array<any | null>,
    ...
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({ class: "content" }), [
        ...
        _cV(_component_navigator, _uM({ url: "/pages/component/list-view/list-view-refresh" }), _uM({
        ...
        _cV(_component_navigator, _uM({ url: "/pages/component/list-view/list-view-multiplex" }), _uM({
          default: withSlotCtx((): any[] => [
            _cE("button", _uM({
              type: "primary",
              class: "button"
        ...
        _cV(_component_navigator, _uM({ url: "/pages/component/list-view/list-view-multiplex-input" }), _uM({
          default: withSlotCtx((): any[] => [
            _cE("button", _uM({
              type: "primary",
              class: "button"
        ...
        _cV(_component_navigator, _uM({ url: "/pages/component/list-view/list-view-multiplex-video" }), _uM({
          default: withSlotCtx((): any[] => [
            _cE("button", _uM({
              type: "primary",
              class: "button"
        ...
        _cV(_component_navigator, _uM({ url: "/pages/component/list-view/list-view-children-in-slot" }), _uM({
          default: withSlotCtx((): any[] => [
            _cE("button", _uM({
              type: "primary",
              class: "button"
        ...
        _cV(_component_navigator, _uM({ url: "/pages/component/list-view/list-view-children-if-show" }), _uM({
          default: withSlotCtx((): any[] => [
            _cE("button", _uM({
              type: "primary",
              class: "button"
        ...
        _cV(_component_navigator, _uM({ url: "/pages/component/list-view/list-view-long-press" }), _uM({
          default: withSlotCtx((): any[] => [
            _cE("button", _uM({
              type: "primary",
              class: "button"
...
const GenPagesComponentListViewListViewStyles = [_uM([["main", _pS(_uM([["maxHeight", 250], ["paddingTop", 5], ["paddingRight", 0], ["paddingBottom", 5], ["paddingLeft", 0], ["borderBottomWidth", 1], ["borderBottomStyle", "solid"], ["borderBottomColor", "rgba(0,0,0,0.06)"], ["flexDirection", "row"], ["justifyContent", "center"]]))], ["list-item", _uM([[".main ", _uM([["width", "100%"], ["height", 250], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#666666"], ["borderRightColor", "#666666"], ["borderBottomColor", "#666666"], ["borderLeftColor", "#666666"], ["backgroundColor", "#66ccff"], ["alignItems", "center"], ["justifyContent", "center"]])]])], ["tip-text", _pS(_uM([["color", "#888888"], ["fontSize", 12]]))], ["refresh-box", _pS(_uM([["justifyContent", "center"], ["alignItems", "center"], ["flexDirection", "row"], ["height", 45], ["width", "100%"]]))], ["button", _pS(_uM([["marginTop", 15]]))]])]
