...
const _component_page_head = resolveEasyComponent("page-head",_easycom_page_head)
  ...
  return _cE("scroll-view", _uM({ class: "uni-flex-item uni-padding-wrap" }), [
    _cV(_component_page_head, _uM({ title: title })),
    _cE("view", _uM({ class: "uni-title" }), [
      _cE("text", _uM({ class: "uni-subtitle-text" }), "无约束宽高"),
      _cE("text", _uM({ class: "uni-subtitle-text" }), _tD(unref(info)), 1 /* TEXT */)
    ]),
    _cE("view", null, [
      _cE("text", _uM({
        id: "text",
    ...
    _cE("view", _uM({ class: "uni-title" }), [
      _cE("text", _uM({ class: "uni-subtitle-text" }), "约束宽高-多行"),
      _cE("text", _uM({ class: "uni-subtitle-text" }), _tD(unref(info2)), 1 /* TEXT */)
    ]),
    ...
    _cE("view", _uM({ class: "uni-title" }), [
      _cE("text", _uM({ class: "uni-subtitle-text" }), "约束宽高-单行"),
      _cE("text", _uM({ class: "uni-subtitle-text" }), _tD(unref(info3)), 1 /* TEXT */)
    ]),
    _cE("view", _uM({ class: "text-box" }), [
      _cE("text", _uM({
        id: "text3",
    ...
    _cE("view", _uM({ class: "uni-title" }), [
      _cE("text", _uM({ class: "uni-subtitle-text" }), "嵌套"),
      _cE("text", _uM({ class: "uni-subtitle-text" }), _tD(unref(info4)), 1 /* TEXT */)
    ]),
    _cE("view", _uM({ class: "text-box" }), [
      _cE("text", _uM({
        id: "text4",
...
const GenPagesComponentTextTextLayoutStyles = [_uM([["text-box", _pS(_uM([["alignItems", "center"]]))], ["text", _pS(_uM([["backgroundColor", "#ffffff"]]))]])]
