  ...
  return _cE("scroll-view", _uM({
    ...
    _cE("view", _uM({ class: "uni-padding-wrap uni-common-mt" }), [
      _cE("view", _uM({ class: "text-box" }), [
        _cE("text", _uM({ class: "text" }), _tD(unref(text)), 1 /* TEXT */)
      ]),
...
const GenPagesComponentTextTextStyles = [_uM([["text-box", _pS(_uM([["marginBottom", 20], ["paddingTop", 20], ["paddingRight", 0], ["paddingBottom", 20], ["paddingLeft", 0], ["display", "flex"], ["minHeight", 150], ["backgroundColor", "#ffffff"], ["justifyContent", "center"], ["alignItems", "center"]]))], ["text", _pS(_uM([["fontSize", 15], ["color", "#353535"], ["lineHeight", "27px"], ["textAlign", "center"]]))]])]
