...
const _component_issue_21223_comp = resolveEasyComponent("issue-21223-comp",_easycom_issue_21223_comp)
  ...
  return _cV(_component_issue_21223_comp, null, _uM({
    default: withScopedSlotCtx((slotProps: Record<string, any | null>): any[] => {
    const items = slotProps["items"]
    return [
      _cE(Fragment, null, RenderHelpers.renderList((items as number[]), (item, __key, __index, _cached): any => {
        return _cE("view", _uM({
          style: _nS(_uM({"position":"absolute","left":"0","top":"0","width":"150px","height":"150px","background-color":"black"}))
