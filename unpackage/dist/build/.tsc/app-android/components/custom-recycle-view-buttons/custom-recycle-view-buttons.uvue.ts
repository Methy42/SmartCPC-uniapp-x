...
return (): any | null => {
  ...
  return _cE("view", _uM({
    ...
    _cE("view", _uM({
      ...
      _cE("text", _uM({ class: "btn-text" }), "点击测试，错误写法")
    ]),
    _cE("view", _uM({
      onClick: onClickRight,
      class: "btn"
    }), [
      _cE("text", _uM({ class: "btn-text" }), "点击测试，正确写法")
    ])
  ], 4 /* STYLE */)
}
}
