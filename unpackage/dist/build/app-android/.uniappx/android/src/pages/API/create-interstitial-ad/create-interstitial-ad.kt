...
open class GenPagesAPICreateInterstitialAdCreateInterstitialAd : BasePage {
    ...
    override fun data(): Map<String, Any?> {
        return _uM("errorDetails" to _uA<String>(), "btnText" to "", "btnType" to "primary", "btnDisable" to false, "interstitialAd" to null as InterstitialAd?, "isAdLoadSuccess" to false)
    }
    ...
    open fun gen_loadAd_fn() {
        ...
        if (this.interstitialAd == null) {
            ...
            this.interstitialAd!!.onError(fun(res){
