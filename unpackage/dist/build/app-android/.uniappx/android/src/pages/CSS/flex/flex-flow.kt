            ...
            _cE("view", _uM("style" to _nS(_uM("flex-grow" to "1"))), _uA(
                _cE("view", null, _uA(
                    ...
                    _cE("view", _uM("class" to "common", "style" to _nS(_uM("flex-flow" to "row nowrap"))), _uA(
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "red", "flex-shrink" to "0"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "green", "flex-shrink" to "0"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "blue", "flex-shrink" to "0"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "red", "flex-shrink" to "0"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "green", "flex-shrink" to "0"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "blue", "flex-shrink" to "0"))), null, 4)
                    ), 4)
