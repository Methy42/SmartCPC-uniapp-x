    ...
    override fun `$render`(): Any? {
        ...
        return _cE("view", _uM("style" to _nS(_uM("flex-grow" to "1"))), _uA(
            _cE("view", _uM("style" to _nS(_uM("height" to "250px", "background-color" to "gray", "justify-content" to "center", "align-items" to "center"))), _uA(
                _cE("text", _uM("class" to "common", "style" to _nS(_uM("font-style" to "italic"))), "font-style: italic", 4),
                _cE("text", _uM("class" to "common", "style" to _nS(_uM("font-style" to "normal"))), "font-style: normal", 4)
            ), 4)
        ), 4)
    }
    companion object {
