...
open class GenPagesCSSTextTextShadow : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return _cE("view", _uM("class" to "container"), _uA(
            ...
            _cE("text", _uM("class" to "text", "style" to _nS(_uM("text-shadow" to "#fc0 1px 0 10px"))), "text-shadow: #fc0 1px 0 10px", 4),
            _cE("text", _uM("class" to "text", "style" to _nS(_uM("text-shadow" to "5px 5px #558abb"))), "text-shadow: 5px 5px #558abb", 4),
            _cE("text", _uM("class" to "text", "style" to _nS(_uM("text-shadow" to "red 2px 5px"))), "text-shadow: red 2px 5px", 4),
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("container" to _pS(_uM("backgroundColor" to "#808080", "justifyContent" to "center")), "text" to _pS(_uM("width" to "100%", "height" to 40, "fontSize" to 20, "textAlign" to "center")))
            }
