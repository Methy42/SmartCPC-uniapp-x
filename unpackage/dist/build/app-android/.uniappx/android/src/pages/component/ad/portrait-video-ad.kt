...
open class GenPagesComponentAdPortraitVideoAd : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return _cE("view", _uM("class" to "container"), _uA(
            _cE("video", _uM("id" to "myVideo1", "src" to _ctx.src, "controls" to true, "autoplay" to "false", "class" to "video", "onPlay" to _ctx.onVideoPlay), _uA(
                if (isTrue(_ctx.adVisible)) {
                    _cE("view", _uM("key" to 0, "class" to "ad-container"), _uA(
                        _cE("ad", _uM("adpid" to "1597617406", "style" to _nS(_uM("width" to "100%", "height" to "100%")), "onLoad" to _ctx.loadFun, "onError" to _ctx.errorFun, "onClose" to _ctx.closeAd), null, 44, _uA(
                            "onLoad",
                            "onError",
                            "onClose"
                        ))
    ...
    open fun gen_setfs_fn() {
        val videoContext = uni_createVideoContext("myVideo1", null)
        videoContext!!.requestFullScreen(RequestFullScreenOptions(direction = 0))
    }
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("container" to _pS(_uM("position" to "relative", "width" to "100%", "height" to "100%", "display" to "flex", "flexDirection" to "column", "alignItems" to "center")), "video" to _pS(_uM("width" to "100%", "height" to "420rpx")), "ad-container" to _pS(_uM("width" to "100%", "height" to "100%", "backgroundColor" to "rgba(0,0,0,0.7)", "display" to "flex", "alignItems" to "center", "justifyContent" to "center")))
            }
