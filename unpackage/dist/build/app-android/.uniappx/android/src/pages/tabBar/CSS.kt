...
open class GenPagesTabBarCSS : BasePage {
            ...
            _cE("view", _uM("class" to _nC(_uA(
                ...
                if (isTrue(!_ctx.hasLeftWin)) {
                    _cE("view", _uM("key" to 1, "class" to "uni-text-box"), _uA(
                        _cE("text", _uM("class" to "hello-text"), "uni-app x目前已支持的CSS属性，展示样式仅供参考，文档详见："),
                        _cV(_component_u_link, _uM("href" to "https://uniapp.dcloud.io/uni-app-x/css/", "text" to "https://uniapp.dcloud.io/uni-app-x/css/", "inWhiteList" to true), null, 8, _uA(
                            "href",
                            "text"
                        ))
                    ))
    ...
    override fun data(): Map<String, Any?> {
        return _uM("menu" to menu__2 as UTSArray<MenuItem>, "arrowRightIcon" to "/static/icons/arrow-right.png", "hasLeftWin" to computed<Boolean>(fun(): Boolean {
