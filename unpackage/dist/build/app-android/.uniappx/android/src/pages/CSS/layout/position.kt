...
open class GenPagesCSSLayoutPosition : BasePage {
        ...
        return _cE("scroll-view", _uM("style" to _nS(_uM("flex" to "1"))), _uA(
            _cE("view", _uM("style" to _nS(_uM("flex-grow" to "1"))), _uA(
                _cE("view", null, _uA(
                    ...
                    _cE("scroll-view", _uM("style" to _nS(_uM("width" to "250px", "height" to "250px", "background-color" to "gray"))), _uA(
                ...
                _cE("view", null, _uA(
                    _cE("text", null, "position: relative"),
                    _cE("scroll-view", _uM("style" to _nS(_uM("width" to "250px", "height" to "250px", "background-color" to "gray"))), _uA(
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "red"))), null, 4),
                ...
                _cE("view", null, _uA(
                    _cE("text", null, "position: absolute"),
                    _cE("scroll-view", _uM("style" to _nS(_uM("width" to "250px", "height" to "250px", "background-color" to "gray"))), _uA(
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "red"))), null, 4),
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("common" to _pS(_uM("width" to 50, "height" to 50, "backgroundColor" to "#008000", "top" to 25, "left" to 25, "justifyContent" to "center", "alignItems" to "center")), "text" to _pS(_uM("whiteSpace" to "nowrap", "width" to "100%")))
            }
