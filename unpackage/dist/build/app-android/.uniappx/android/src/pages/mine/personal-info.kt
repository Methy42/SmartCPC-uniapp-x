...
open class GenPagesMinePersonalInfo : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesMinePersonalInfo) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesMinePersonalInfo
                ...
                return _cE("view", _uM("class" to "container"), _uA(
                    ...
                    _cE("view", _uM("class" to "content-container"), _uA(
                        _cE("view", _uM("class" to "content-title-container"), _uA(
                            ...
                            _cE("text", _uM("class" to "content-title-text"), "个人资料")
                        )),
