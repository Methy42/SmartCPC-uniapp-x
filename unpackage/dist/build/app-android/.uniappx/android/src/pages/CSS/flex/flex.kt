...
open class GenPagesCSSFlexFlex : BasePage {
            ...
            _cE("view", _uM("style" to _nS(_uM("flex-grow" to "1"))), _uA(
                _cE("view", null, _uA(
                    ...
                    _cE("view", _uM("style" to _nS(_uM("width" to "250px", "height" to "150px", "background-color" to "gray", "flex-direction" to "row"))), _uA(
                        _cE("view", _uM("class" to "common", "style" to _nS(_uM("min-width" to "25px", "flex" to "0"))), null, 4),
                ...
                _cE("view", null, _uA(
                    ...
                    _cE("view", _uM("style" to _nS(_uM("width" to "250px", "height" to "150px", "background-color" to "gray", "flex-direction" to "row"))), _uA(
                        _cE("view", _uM("class" to "common", "style" to _nS(_uM("flex" to "1"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "green"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "blue"))), null, 4)
                    ), 4)
                )),
                _cE("view", null, _uA(
                    ...
                    _cE("view", _uM("style" to _nS(_uM("width" to "250px", "height" to "150px", "background-color" to "gray", "flex-direction" to "row"))), _uA(
                        _cE("view", _uM("class" to "common", "style" to _nS(_uM("flex" to "auto"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "green"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "blue"))), null, 4)
                    ), 4)
                )),
                _cE("view", null, _uA(
                    ...
                    _cE("view", _uM("style" to _nS(_uM("width" to "250px", "height" to "150px", "background-color" to "gray", "flex-direction" to "row"))), _uA(
                        _cE("view", _uM("class" to "common", "style" to _nS(_uM("flex" to "none"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "green"))), null, 4),
                        _cE("view", _uM("style" to _nS(_uM("width" to "50px", "height" to "50px", "background-color" to "blue"))), null, 4)
                    ), 4)
                ))
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("common" to _pS(_uM("width" to 50, "height" to 50, "backgroundColor" to "#FF0000")))
            }
