...
open class GenPagesTabBarComponent : BasePage {
    ...
    override fun data(): Map<String, Any?> {
        return _uM("menu" to uni.UNI2A1DFEF.menu as UTSArray<MenuItem>, "arrowRightIcon" to "/static/icons/arrow-right.png" as String, "pageHiden" to false, "hasLeftWin" to computed<Boolean>(fun(): Boolean {
