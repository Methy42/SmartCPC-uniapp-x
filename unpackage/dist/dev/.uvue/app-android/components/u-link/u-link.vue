const __sfc__ = defineComponent({
    ...
    setup(__props) {
        ...
        return (): any | null => {
            return _cE("view", _uM({ class: "uni-row" }), [
                _cE("text", _uM({
                    class: "text",
                    href: _ctx.href,
                    onClick: openURL,
                    inWhiteList: _ctx.inWhiteList
                }), _tD(_ctx.text), 9 /* TEXT, PROPS */, ["href", "inWhiteList"])
            ]);
        };
    }
});
...
const GenComponentsULinkULinkStyles = [_uM([["text", _pS(_uM([["color", "#7A7E83"], ["fontSize", 14], ["lineHeight", "20px"]]))]])];
