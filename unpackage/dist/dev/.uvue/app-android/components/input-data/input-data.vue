...
const __sfc__ = defineComponent({
    ...
    setup(__props) {
        ...
        function _getValue(value: string | number): InputValue {
            switch (props.type) {
                case 'number':
