  ...
  const __sfc__ = defineComponent({
    ...
    methods: {
      itemClick(e : UniRichTextItemClickEvent) {
        console.log(JSON.stringify(e.detail), " at pages/component/rich-text/rich-text-complex.uvue:35");
        let clicktext = '';
      ...
      fViewClick(e : string) {
        console.log(e, " at pages/component/rich-text/rich-text-complex.uvue:49")
        this.fViewClicked = true
      },
      selfClick(e : string) {
        console.log(e, " at pages/component/rich-text/rich-text-complex.uvue:53")
...
const _component_enum_data = resolveEasyComponent("enum-data",_easycom_enum_data)
  ...
  return _cE("scroll-view", _uM({
    ...
    _cE("view", null, [
      _cV(_component_page_head, _uM({ title: "rich-text-complex" })),
      ...
      _cE("view", _uM({
        ...
        _cE("rich-text", _uM({
          ...
          mode: _ctx.mode
        }), null, 40 /* PROPS, NEED_HYDRATION */, ["nodes", "onItemclick", "onClick", "mode"])
      ], 8 /* PROPS */, ["onClick"])
    ])
  ], 4 /* STYLE */)
}
