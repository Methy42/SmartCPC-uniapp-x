...
const _component_navigator = resolveComponent("navigator")
  ...
  return _cE("view", null, [
    ...
    _cE("view", _uM({ class: "content" }), [
      ...
      _cE("text", _uM({
        style: _nS(_uM({"padding":"10px"}))
      }), _tD(_ctx.touchResult), 5 /* TEXT, STYLE */),
      _cE("view", _uM({
...
const GenPagesComponentGlobalEventsTouchEventsCaseStyles = [_uM([["h-300", _pS(_uM([["height", 300]]))], ["header-tiem", _pS(_uM([["backgroundColor", "#89ff8d"], ["alignItems", "center"], ["justifyContent", "center"]]))]])]
