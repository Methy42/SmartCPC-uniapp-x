...
const _component_page_head = resolveEasyComponent("page-head",_easycom_page_head)
  ...
  return _cE("scroll-view", _uM({
    ...
    _cV(_component_page_head, _uM({ title: "事件冒泡测试" })),
    _cE("view", _uM({ class: "container" }), [
      ...
      _cE("view", _uM({
        ...
        _cE("view", _uM({
          ...
          _cE("view", _uM({
            style: _nS(_uM({"background-color":"beige"})),
            class: "icon",
            id: "view2-3",
            onTouchstart: _ctx.onTouchStart,
            onTouchend: _ctx.onTouchEnd
...
const GenPagesComponentGlobalEventsTouchEventsBubblesStyles = [_uM([["container", _pS(_uM([["width", "100%"], ["height", "80%"], ["flexDirection", "column"], ["alignItems", "center"], ["justifyContent", "space-between"]]))], ["view-box", _pS(_uM([["width", 200], ["height", 200], ["alignItems", "center"], ["justifyContent", "center"], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"]]))], ["mid-view", _pS(_uM([["width", 150], ["height", 150], ["alignItems", "center"], ["justifyContent", "center"], ["backgroundColor", "#00FFFF"]]))], ["icon", _pS(_uM([["width", 100], ["height", 100]]))]])]
