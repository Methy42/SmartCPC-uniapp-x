  ...
  type RefresherEventTest = { __$originalPosition?: UTSSourceMapPosition<"RefresherEventTest", "pages/component/list-view/list-view-refresh.uvue", 15, 8>;
    type : string;
    ...
    ? _cE("list-view", _uM({
        ...
        _cE(Fragment, null, RenderHelpers.renderList(_ctx.item_count, (index, __key, __index, _cached): any => {
          return _cE("list-item", _uM({ class: "item" }), [
            _cE("text", null, "item-------" + _tD(index), 1 /* TEXT */)
          ])
