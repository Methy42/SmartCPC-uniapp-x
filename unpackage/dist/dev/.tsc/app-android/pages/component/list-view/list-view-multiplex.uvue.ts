...
const _component_switch = resolveComponent("switch")
  ...
  return _cE("view", _uM({
    ...
    withDirectives(_cE("list-view", _uM({
      id: "listview",
      style: _nS(_uM({"flex":"1"})),
        ...
        return _cE("list-item", _uM({
          ...
          _cE("view", _uM({
            ...
            _cE("scroll-view", _uM({
              ...
              _cE("text", null, "scroll-view" + _tD(index) + "：", 1 /* TEXT */),
              _cE(Fragment, null, RenderHelpers.renderList(5, (tab, __key, __index, _cached): any => {
                return _cE("text", _uM({ class: "tip_text" }), "元素" + _tD(tab), 1 /* TEXT */)
              }), 64 /* STABLE_FRAGMENT */)
            ])
          ], 4 /* STYLE */),
          withDirectives(_cE("text", null, [
            "item-------",
            _cE("text", null, _tD(index), 1 /* TEXT */)
          ], 512 /* NEED_PATCH */), [
