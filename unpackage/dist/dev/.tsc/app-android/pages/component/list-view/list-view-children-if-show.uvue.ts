...
type Child = { __$originalPosition?: UTSSourceMapPosition<"Child", "pages/component/list-view/list-view-children-if-show.uvue", 32, 6>;
	id: string
}
type List = { __$originalPosition?: UTSSourceMapPosition<"List", "pages/component/list-view/list-view-children-if-show.uvue", 35, 6>;
	id: string
	children: Child[]
}
