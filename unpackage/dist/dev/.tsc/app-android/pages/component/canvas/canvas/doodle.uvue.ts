  ...
  type Point = { __$originalPosition?: UTSSourceMapPosition<"Point", "pages/component/canvas/canvas/doodle.uvue", 9, 8>;
    x : number
    y : number
  };
...
const GenPagesComponentCanvasCanvasDoodleStyles = [_uM([["drawing", _pS(_uM([["width", "100%"], ["height", 500], ["backgroundColor", "#D3D3D3"], ["marginBottom", 15]]))]])]
