    ...
    methods: {
      ...
      fontTTF() {
        ...
        var drawFont = (key : string, value : UTSJSONObject) => {
          console.log(`${key}字体加载成功`, " at pages/component/canvas/canvas-context.uvue:820")
          context.save()
        ...
        fontMap.forEach((value : UTSJSONObject, key : string) => {
          console.log(`key:${key} value:${value["path"]}`, " at pages/component/canvas/canvas-context.uvue:832")
          if (this.fontLoaded) {
            drawFont(key, value)
          } else {
            uni.loadFontFace({
...
function GenPagesComponentCanvasCanvasContextRender(this: InstanceType<typeof __sfc__>): any | null {
const _ctx = this
  ...
  return _cE("view", _uM({
    ...
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({ class: "grid-view" }), [
        _cE(Fragment, null, RenderHelpers.renderList(_ctx.names, (name, index, __index, _cached): any => {
          return _cE("view", _uM({
            class: "grid-item",
            key: index
          }), [
            _cE("button", _uM({
              ...
              onClick: () => {_ctx.handleCanvasButton(name)}
...
const GenPagesComponentCanvasCanvasContextStyles = [_uM([["page", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["scroll-view", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["canvas-element", _pS(_uM([["width", "100%"], ["height", 250], ["backgroundColor", "#ffffff"]]))], ["grid-view", _pS(_uM([["paddingTop", 10], ["paddingRight", 10], ["paddingBottom", 10], ["paddingLeft", 10], ["flexDirection", "row"], ["flexWrap", "wrap"]]))], ["grid-item", _pS(_uM([["width", "50%"], ["paddingTop", 5], ["paddingRight", 5], ["paddingBottom", 5], ["paddingLeft", 5]]))]])]
