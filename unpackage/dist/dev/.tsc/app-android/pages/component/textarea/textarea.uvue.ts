  ...
  return _cE("scroll-view", _uM({
    ...
    _cE("view", _uM({ class: "main" }), [
      _cE("textarea", _uM({
        ...
        onClick: [_ctx.textarea_click, _ctx.textarea_tap] as Array<any | null>,
        ...
        style: _nS(_uM({"padding":"10px","border":"1px solid #666","height":"200px"}))
    ...
    _cE("view", _uM({
      style: _nS(_uM({"margin-bottom":"40px"}))
    }), [
      ...
      _cE("view", _uM({ class: "title-wrap" }), [
        _cE("view", null, "maxlength 输入最大长度为10")
      ]),
      _cE("view", _uM({ class: "textarea-wrap" }), [
        _cE("textarea", _uM({
      ...
      _cE("view", _uM({ class: "textarea-wrap" }), [
        _cE("textarea", _uM({
          ...
          onInput: ($event: UniInputEvent) => {(_ctx.defaultModel) = $event.detail.value},
          value: "456"
      ...
      _cE("view", _uM({ class: "textarea-wrap" }), [
        _cE("textarea", _uM({
          class: "textarea-instance",
          style: _nS(_uM({"line-height":"1.2em"})),
      ...
      _cE("view", _uM({ class: "textarea-wrap" }), [
        _cE("textarea", _uM({
          class: "textarea-instance",
          style: _nS(_uM({"height":"50px","text-align":"right"})),
...
const GenPagesComponentTextareaTextareaStyles = [_uM([["main", _pS(_uM([["minHeight", 100], ["paddingTop", 5], ["paddingRight", 0], ["paddingBottom", 5], ["paddingLeft", 0], ["borderBottomWidth", 1], ["borderBottomStyle", "solid"], ["borderBottomColor", "rgba(0,0,0,0.06)"], ["flexDirection", "row"], ["justifyContent", "center"]]))], ["test-width", _pS(_uM([["width", 100], ["height", 100], ["backgroundColor", "#00FFFF"]]))], ["textarea-wrap", _pS(_uM([["flexDirection", "row"], ["justifyContent", "center"]]))], ["title-wrap", _pS(_uM([["flexDirection", "row"], ["alignItems", "center"], ["marginLeft", 10]]))], ["textarea-instance", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#666666"], ["borderRightColor", "#666666"], ["borderBottomColor", "#666666"], ["borderLeftColor", "#666666"], ["marginTop", 10], ["marginRight", 10], ["marginBottom", 10], ["marginLeft", 10]]))], ["placeholder", _pS(_uM([["backgroundColor", "#FFFF00"]]))]])]
