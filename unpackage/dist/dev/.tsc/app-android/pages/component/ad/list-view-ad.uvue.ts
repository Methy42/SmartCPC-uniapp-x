...
const _cache = this.$.renderCache
  return _cE("list-view", _uM({
    ...
    _cE(Fragment, null, RenderHelpers.renderList(_ctx.listcount, (index, __key, __index, _cached): any => {
      return _cE("list-item", _uM({
        ...
        isTrue(index == 0 || index%10 != 6)
          ? _cE("text", _uM({
              key: 1,
              style: _nS(_uM({"width":"100%","height":"200px","background-color":"aquamarine","margin-top":"10px"}))
            }), "这是一条占位的信息" + _tD(index), 5 /* TEXT, STYLE */)
          : _cC("v-if", true)
      ], 8 /* PROPS */, ["type"])
