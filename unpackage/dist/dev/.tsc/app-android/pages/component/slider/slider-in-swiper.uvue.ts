  ...
  type SwiperTabsItem = { __$originalPosition?: UTSSourceMapPosition<"SwiperTabsItem", "pages/component/slider/slider-in-swiper.uvue", 38, 8>;
    x : number,
    w : number
  }

  type SwiperViewItem = { __$originalPosition?: UTSSourceMapPosition<"SwiperViewItem", "pages/component/slider/slider-in-swiper.uvue", 43, 8>;
    title : string,
  }
  ...
  return _cE("view", _uM({ class: "swiper-list" }), [
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({ class: "flex-row" }), [
        _cE(Fragment, null, RenderHelpers.renderList(_ctx.swiperList, (item, index, __index, _cached): any => {
          return _cE("text", _uM({
            ref_for: true,
            ref: "swipertab",
            space: "nbsp",
            class: _nC(["swiper-tabs-item", _ctx.swiperIndex==index ? 'swiper-tabs-item-active' : '']),
            key: index,
    ...
    _cE("swiper", _uM({
      ...
      _cE(Fragment, null, RenderHelpers.renderList(_ctx.swiperList, (_, index, __index, _cached): any => {
        return _cE("swiper-item", _uM({
          class: "swiper-item",
          key: index
        }), [
          _cE("text", _uM({ class: "uni-title" }), "显示当前value"),
          _cV(_component_slider, _uM({
            value: 50,
            "show-value": true
          })),
          _cE("text", _uM({ class: "uni-title" }), "设置步进:step=10跳动"),
          _cV(_component_slider, _uM({
            value: 60,
            step: 10
          })),
          _cE("text", _uM({ class: "uni-title" }), "浮点步进:step=0.01跳动"),
          _cV(_component_slider, _uM({
            value: 0.5,
            min: 0,
            max: 1,
          ...
          _cE("text", _uM({ class: "uni-title" }), "设置最小/最大值"),
          _cV(_component_slider, _uM({
            value: 100,
            min: 50,
            max: 200,
          ...
          _cE("text", _uM({ class: "uni-title" }), "不同颜色和大小的滑块"),
          _cV(_component_slider, _uM({
...
const GenPagesComponentSliderSliderInSwiperStyles = [_uM([["flex-row", _pS(_uM([["flexDirection", "row"], ["alignSelf", "flex-start"]]))], ["swiper-list", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["swiper-tabs", _pS(_uM([["backgroundColor", "#ffffff"]]))], ["swiper-tabs-item", _pS(_uM([["color", "#555555"], ["fontSize", 16], ["paddingTop", 12], ["paddingRight", 25], ["paddingBottom", 12], ["paddingLeft", 25], ["whiteSpace", "nowrap"]]))], ["swiper-tabs-item-active", _pS(_uM([["color", "#007AFF"]]))], ["swiper-tabs-indicator", _pS(_uM([["width", 1], ["height", 2], ["backgroundColor", "#007AFF"]]))], ["swiper-view", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["swiper-item", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["paddingTop", 15], ["paddingRight", 15], ["paddingBottom", 15], ["paddingLeft", 15]]))]])]
