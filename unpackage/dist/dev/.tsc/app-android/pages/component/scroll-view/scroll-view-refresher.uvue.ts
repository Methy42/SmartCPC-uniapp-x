  ...
  type RefresherEventTest = { __$originalPosition?: UTSSourceMapPosition<"RefresherEventTest", "pages/component/scroll-view/scroll-view-refresher.uvue", 16, 8>;
    type : string;
...
const _component_page_head = resolveEasyComponent("page-head",_easycom_page_head)
  ...
  return _cE("view", _uM({ class: "container" }), [
    _cV(_component_page_head, _uM({ title: "scroll-view 下拉刷新" })),
    _cE("scroll-view", _uM({
      class: "scroll",
...
const GenPagesComponentScrollViewScrollViewRefresherStyles = [_uM([["container", _pS(_uM([["display", "flex"], ["flexDirection", "column"], ["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["scroll", _pS(_uM([["backgroundColor", "#eeeeee"], ["position", "relative"], ["width", "100%"], ["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["display", "flex"], ["flexDirection", "column"], ["borderTopColor", "#FF0000"], ["borderRightColor", "#FF0000"], ["borderBottomColor", "#FF0000"], ["borderLeftColor", "#FF0000"], ["borderTopLeftRadius", 6], ["borderTopRightRadius", 6], ["borderBottomRightRadius", 6], ["borderBottomLeftRadius", 6]]))], ["scroll-item", _pS(_uM([["marginLeft", 6], ["marginRight", 6], ["marginTop", 6], ["backgroundColor", "#ffffff"], ["borderTopLeftRadius", 4], ["borderTopRightRadius", 4], ["borderBottomRightRadius", 4], ["borderBottomLeftRadius", 4]]))], ["scroll-item-title", _pS(_uM([["width", "100%"], ["height", 60], ["lineHeight", "60px"], ["textAlign", "center"], ["color", "#555555"]]))]])]
