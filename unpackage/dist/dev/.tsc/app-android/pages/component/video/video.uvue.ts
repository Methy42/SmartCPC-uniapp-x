  ...
  const __sfc__ = defineComponent({
    ...
    methods: {
      ...
      onSendDanmuInput: function (event : UniInputEvent) {
        let json = UTSAndroid.consoleDebugError(JSON.parse<Danmu>(event.detail.value), " at pages/component/video/video.uvue:283")
        if (json == null) return;
      ...
      onHeaderComfirm: function (event : UniInputConfirmEvent) {
        let json = UTSAndroid.consoleDebugError(JSON.parse(event.detail.value), " at pages/component/video/video.uvue:443")
        if (json == null) return;
  ...
  return _cE("view", _uM({ class: "uni-flex-item" }), [
    ...
    _cE("scroll-view", _uM({ class: "uni-padding-wrap uni-common-mt uni-flex-item" }), [
      _cE("view", _uM({ class: "uni-btn-v" }), [
        _cV(_component_navigator, _uM({ url: "/pages/component/video/video-format" }), _uM({
      ...
      _cE("view", _uM({
        ...
        style: _nS(_uM({"justify-content":"space-between","align-items":"center"}))
      }), [
        _cE("text", _uM({
          class: "uni-title",
      ...
      _cV(_component_boolean_data, _uM({
        title: "设置是否对http、https视频源开启本地缓存（仅 Android、iOS 平台，播放前设置有效）",
        defaultValue: _ctx.httpCache,
        onChange: _ctx.onHttpCacheChange
      }), null, 8 /* PROPS */, ["defaultValue", "onChange"]),
      _cV(_component_enum_data, _uM({
        title: "设置解码器（仅 Android、iOS 平台，播放前设置有效）",
        items: _ctx.codecItemTypes,
        onChange: _ctx.onCodecChange
      }), null, 8 /* PROPS */, ["items", "onChange"]),
      _cV(_component_enum_data, _uM({
        title: "设置播放策略（仅 Android、iOS 平台，播放前设置有效）",
...
const GenPagesComponentVideoVideoStyles = [_uM([["video", _pS(_uM([["width", "100%"], ["height", 200]]))], ["input", _pS(_uM([["height", 40], ["backgroundImage", "none"], ["backgroundColor", "#FFFFFF"], ["paddingTop", 8], ["paddingRight", 13], ["paddingBottom", 8], ["paddingLeft", 13]]))], ["margin-10", _pS(_uM([["marginTop", 10], ["marginRight", 10], ["marginBottom", 10], ["marginLeft", 10]]))], ["img-fast-backward", _pS(_uM([["width", 40], ["height", 40], ["top", "50%"], ["left", "12%"], ["transform", "translate(-50%, -50%)"], ["position", "absolute"]]))], ["img-fast-forward", _pS(_uM([["width", 40], ["height", 40], ["top", "50%"], ["right", "12%"], ["transform", "translate(50%, -50%)"], ["position", "absolute"]]))], ["input-send-danmu", _pS(_uM([["height", 40], ["paddingTop", 8], ["paddingRight", 13], ["paddingBottom", 8], ["paddingLeft", 13], ["marginTop", 0], ["marginRight", CSS_VAR_STATUS_BAR_HEIGHT], ["marginBottom", 0], ["marginLeft", CSS_VAR_STATUS_BAR_HEIGHT], ["bottom", 50], ["position", "absolute"], ["backgroundColor", "rgba(0,0,0,0.5)"], ["color", "#FFFFFF"]]))]])]
...
import _imports_0 from '../../../static/test-video/fast-backward.png'
import _imports_1 from '../../../static/test-video/fast-forward.png'
