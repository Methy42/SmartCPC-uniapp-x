...
const _component_switch = resolveComponent("switch")
  ...
  return _cE("scroll-view", _uM({
    ...
    _cE("view", _uM({
      ...
      style: _nS(_uM({"padding-bottom":"30px"}))
    }), [
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "设置输入框的初始内容")
        ]),
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "type取值（不同输入法表现可能不一致）")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "密码输入框")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "无value设置的密码输入框")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            class: "uni-input",
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "占位符样式")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
        ...
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            id: "uni-input-placeholder2",
            style: _nS(_uM({"font-family":"AlimamaDaoLiTiOTF","font-weight":"bold","text-align":"right"})),
            class: "uni-input",
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "设置禁用输入框")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "设置最大输入长度")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "设置光标与键盘的距离")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            class: "uni-input",
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "自动获取焦点")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            id: "uni-input-focus",
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "confirm-type取值（不同输入法表现可能不一致）")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "点击键盘右下角按钮时保持键盘不收起")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            class: "uni-input",
      ...
      _cE("view", null, [
        _cE("view", _uM({
          ...
          _cE("text", _uM({ class: "uni-title-text" }), "设置输入框聚焦时光标的位置（点这里）")
        ], 8 /* PROPS */, ["onClick"]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            ref: "input",
      ...
      _cE("view", null, [
        _cE("view", _uM({
          ...
          _cE("text", _uM({ class: "uni-title-text" }), "设置输入框聚焦时光标的起始位置和结束位置（点这里）")
        ], 8 /* PROPS */, ["onClick"]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            ref: "input2",
      ...
      _cE("view", null, [
        _cE("view", _uM({
          class: "uni-title",
          style: _nS(_uM({"flex-direction":"row","align-items":"center"}))
        }), [
          _cE("text", _uM({
            class: "uni-title-text",
            style: _nS(_uM({"flex-shrink":"1"}))
          }), "设置光标颜色为红色（Android的微信小程序非skyline下仅支持黑和绿）", 4 /* STYLE */),
          _cV(_component_switch, _uM({
            style: _nS(_uM({"margin-left":"10px"})),
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "键盘弹起时，自动上推页面")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            class: "uni-input",
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "input事件"),
          isTrue(_ctx.inputEventDetail)
            ? _cE("text", _uM({
                key: 0,
                class: "uni-subtitle-text"
              }), _tD(_ctx.inputEventDetail), 1 /* TEXT */)
            : _cC("v-if", true)
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
        ...
        _cE("view", _uM({ class: "uni-title" }), [
          ...
          isTrue(_ctx.focusAndBlurEventDetail)
            ? _cE("text", _uM({
                key: 0,
                class: "uni-subtitle-text"
              }), _tD(_ctx.focusAndBlurEventDetail), 1 /* TEXT */)
            : _cC("v-if", true)
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "confirm事件"),
          isTrue(_ctx.confirmEventDetail)
            ? _cE("text", _uM({
                key: 0,
                class: "uni-subtitle-text"
              }), _tD(_ctx.confirmEventDetail), 1 /* TEXT */)
            : _cC("v-if", true)
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "change事件"),
          isTrue(_ctx.changeEventDetail)
            ? _cE("text", _uM({
                key: 0,
                class: "uni-subtitle-text"
              }), _tD(_ctx.changeEventDetail), 1 /* TEXT */)
            : _cC("v-if", true)
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "带清除按钮的输入框")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            class: "uni-input",
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "可查看密码的输入框")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            class: "uni-input",
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "同时存在 v-model 和 value")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            id: "both-model-value",
            ...
            onInput: ($event: UniInputEvent) => {(_ctx.demoValue) = $event.detail.value},
            value: "456"
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "同时存在 v-model 和 change事件")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            id: "both-model-value",
            ...
            onInput: ($event: UniInputEvent) => {(_ctx.demoValue2) = $event.detail.value},
            value: "123",
            onChange: _ctx.onChange
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "输入内容的同步更新UI")
        ]),
        _cE("text", null, _tD(_ctx.syncDisplayValue), 1 /* TEXT */),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            class: "uni-input",
            modelValue: _ctx.syncDisplayValue,
            onInput: ($event: UniInputEvent) => {(_ctx.syncDisplayValue) = $event.detail.value}
          }), null, 40 /* PROPS, NEED_HYDRATION */, ["modelValue", "onInput"])
        ])
      ]),
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "maxlength初始化生效")
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
            class: "uni-input",
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-title" }), [
          _cE("text", _uM({ class: "uni-title-text" }), "keyboardheightchange事件"),
          isTrue(_ctx.keyboardHeightChangeEventDetail)
            ? _cE("text", _uM({
                key: 0,
                class: "uni-subtitle-text"
              }), _tD(_ctx.keyboardHeightChangeEventDetail), 1 /* TEXT */)
            : _cC("v-if", true)
        ]),
        _cE("view", _uM({ class: "input-wrapper" }), [
          _cE("input", _uM({
...
const GenPagesComponentInputInputStyles = [_uM([["input-wrapper", _pS(_uM([["display", "flex"], ["paddingTop", 8], ["paddingRight", 13], ["paddingBottom", 8], ["paddingLeft", 13], ["marginTop", 5], ["marginRight", 0], ["marginBottom", 5], ["marginLeft", 0], ["flexDirection", "row"], ["flexWrap", "nowrap"], ["backgroundColor", "#ffffff"]]))], ["uni-input", _pS(_uM([["height", 28], ["fontSize", 15], ["paddingTop", 0], ["paddingRight", 0], ["paddingBottom", 0], ["paddingLeft", 0], ["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["backgroundColor", "#ffffff"]]))], ["uni-icon", _pS(_uM([["width", 24], ["height", 24]]))], ["uni-input-placeholder-class", _pS(_uM([["fontSize", 10]]))], ["@FONT-FACE", _uM([["0", _uM([["fontFamily", "AlimamaDaoLiTiOTF"], ["src", "url('/static/font/AlimamaDaoLiTi.otf')"]])]])]])]
