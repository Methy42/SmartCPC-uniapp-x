...
const _cache = this.$.renderCache
  return _cE("scroll-view", _uM({
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改宽度(通过style设置transition)"),
      _cE("view", _uM({
        class: "base-style",
        style: _nS(_uM({"transition-property":"width","transition-duration":"1s"})),
        id: "widthOrHeightStyle",
        onClick: _ctx.changeWidthOrHeightStyle
      }), null, 12 /* STYLE, PROPS */, ["onClick"])
    ]),
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改Margin"),
      _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改Padding"),
      _cE("view", _uM({
        ...
        _cE("view", _uM({
          style: _nS(_uM({"background-color":"black","height":"50px","width":"50px"}))
        }), null, 4 /* STYLE */)
      ], 8 /* PROPS */, ["onClick"])
    ]),
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改background-color和opacity"),
      _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改background-color（rgba）"),
      _cE("view", _uM({
        style: _nS(_uM({"flex":"1"}))
      }), [
        _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改opacity渐隐渐现"),
      _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "动态修改background-color和duration"),
      _cE("view", _uM({
        class: "base-style",
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改Transform"),
      _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改TransformTranslate"),
      _cE("view", _uM({
        class: "base-style transition-transform",
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改Transform和宽"),
      _cE("view", _uM({
    ...
    _cE("view", _uM({
      ...
      _cE("text", _uM({ class: "text" }), "点击修改Transform（含transform-origin）"),
      _cE("view", _uM({
        class: "base-style transition-transform",
        style: _nS(_uM({"transform-origin":"0 0"})),
        id: "styleTransformWithOrigin"
      }), null, 4 /* STYLE */)
    ], 8 /* PROPS */, ["onClick"]),
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改Border"),
      _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改Position"),
      _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改Scale "),
      _cE("view", _uM({
        class: "base-style transition-transform",
        id: "styleChangScale",
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "仅指定transition-duration背影有动画为正常"),
      _cE("view", _uM({
        style: _nS([_uM({"width":"100%","height":"50px"}), _ctx.changestyleTransitionDuration]),
        onClick: _ctx.doChangeTransitionDuration
      }), null, 12 /* STYLE, PROPS */, ["onClick"])
    ]),
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "transition-property: all/none 演示"),
      _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "在组件内滑动测试是否闪动"),
      _cE("view", _uM({
        class: "base-style transition-transform",
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "测试在style中同时修改transform和width"),
      _cE("view", _uM({
        ...
        _cE("view", _uM({
          class: "base-style transition-transform-width",
          id: "styleTransformTranslateScale",
          style: _nS(_uM({transform:`translateX(${_ctx.lineLeft}px)`,width:`${_ctx.lineWidth}px`})),
          onClick: _ctx.changeTransform61
        }), null, 12 /* STYLE, PROPS */, ["onClick"])
      ], 4 /* STYLE */)
    ]),
    _cE("view", _uM({ class: "container" }), [
      _cE("text", _uM({ class: "text" }), "点击修改宽度(值为auto有无动画交替出现)"),
      _cE("view", _uM({
        class: "base-style transition-width",
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("view", _uM({ class: "text" }), "重复修改width"),
      _cE("view", _uM({
        class: "base-style transition-width",
        id: "changeWidthInEnd",
        style: _nS(_uM({"transition-duration":"0.5s"})),
...
const GenPagesCSSTransitionTransitionStyles = [_uM([["container", _pS(_uM([["marginTop", 7], ["marginRight", 7], ["marginBottom", 7], ["marginLeft", 7], ["backgroundColor", "#FFFFFF"]]))], ["text", _pS(_uM([["marginTop", 10], ["marginBottom", 16]]))], ["base-style", _pS(_uM([["width", 200], ["height", 200], ["backgroundColor", "#A52A2A"]]))], ["width-progress", _pS(_uM([["width", 200], ["height", 200], ["backgroundColor", "#A52A2A"]]))], ["transform-bgColor", _pS(_uM([["transitionProperty", "backgroundColor"], ["transitionDuration", "0.5s"]]))], ["transition-width", _pS(_uM([["transitionProperty", "width"], ["transitionDuration", "1s"]]))], ["transition-margin", _pS(_uM([["transitionProperty", "marginLeft,marginTop"], ["transitionDuration", "1s"]]))], ["transition-padding", _pS(_uM([["transitionProperty", "paddingLeft,paddingTop"], ["transitionDuration", "1s"]]))], ["transition-background", _pS(_uM([["transitionProperty", "backgroundColor,opacity"], ["transitionDuration", "1s"]]))], ["transition-opacity", _pS(_uM([["transitionProperty", "opacity"], ["transitionDuration", "1s"]]))], ["transition-transform", _pS(_uM([["transform", "translate(0%, 0%) scaleX(1) rotate(0deg)"], ["transitionProperty", "transform"], ["transitionDuration", "1s"]]))], ["transition-border", _pS(_uM([["borderTopWidth", 5], ["borderRightWidth", 5], ["borderBottomWidth", 5], ["borderLeftWidth", 5], ["borderTopColor", "#A52A2A"], ["borderRightColor", "#A52A2A"], ["borderBottomColor", "#A52A2A"], ["borderLeftColor", "#A52A2A"], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["transitionProperty", "borderColor"], ["transitionDuration", "1s"]]))], ["transition-position", _pS(_uM([["left", 0], ["transitionProperty", "left"], ["transitionDuration", "1s"]]))], ["transition-transform-width", _pS(_uM([["transform", "rotate(0deg)"], ["transitionProperty", "transform,width"], ["transitionDuration", "1s"]]))], ["transition-all", _pS(_uM([["transitionProperty", "all"], ["transitionDuration", "1s"]]))], ["@TRANSITION", _uM([["transform-bgColor", _uM([["property", "backgroundColor"], ["duration", "0.5s"]])], ["transition-width", _uM([["property", "width"], ["duration", "1s"]])], ["transition-margin", _uM([["property", "marginLeft,marginTop"], ["duration", "1s"]])], ["transition-padding", _uM([["property", "paddingLeft,paddingTop"], ["duration", "1s"]])], ["transition-background", _uM([["property", "backgroundColor,opacity"], ["duration", "1s"]])], ["transition-opacity", _uM([["property", "opacity"], ["duration", "1s"]])], ["transition-transform", _uM([["property", "transform"], ["duration", "1s"]])], ["transition-border", _uM([["property", "borderColor"], ["duration", "1s"]])], ["transition-position", _uM([["property", "left"], ["duration", "1s"]])], ["transition-transform-width", _uM([["property", "transform,width"], ["duration", "1s"]])], ["transition-all", _uM([["property", "all"], ["duration", "1s"]])]])]])]
