...
type RequestResult = { __$originalPosition?: UTSSourceMapPosition<"RequestResult", "pages/login/login.uvue", 63, 6>;
  statusCode: number,
  data: any
}
  ...
  methods: {
    ...
    initRememberPassword() {
      try {
        ...
        console.error('读取记住密码失败:', e, " at pages/login/login.uvue:120")
      }
    },
        ...
        const res = await new Promise<RequestResult>((resolve, reject) => {
          uni.request({
            ...
            success: (r) => {
              ...
              const ro = UTSAndroid.consoleDebugError(JSON.parse(rStr), " at pages/login/login.uvue:143") as UTSJSONObject
