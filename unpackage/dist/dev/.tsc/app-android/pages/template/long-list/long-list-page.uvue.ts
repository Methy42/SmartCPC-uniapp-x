...
type ListItem = { __$originalPosition?: UTSSourceMapPosition<"ListItem", "pages/template/long-list/long-list-page.uvue", 36, 6>;
  plugin_id : number,
...
type ResponseDataType = { __$originalPosition?: UTSSourceMapPosition<"ResponseDataType", "pages/template/long-list/long-list-page.uvue", 47, 6>;
  code : number,
  data : ListItem[]
}
...
const _component_uni_loading = resolveEasyComponent("uni-loading",_easycom_uni_loading)
  ...
  return _cE("list-view", _uM({
    ...
    _cE(Fragment, null, RenderHelpers.renderList(unref(dataList), (item, _, __index, _cached): any => {
      return _cE("list-item", _uM({
        class: "list-item",
        key: item.plugin_id,
        type: "10"
      }), [
        _cE("view", _uM({ class: "list-item-icon" }), [
          _cE("image", _uM({
        ...
        _cE("view", _uM({ class: "list-item-fill" }), [
          ...
          _cE("view", _uM({ class: "tag-list" }), [
            _cE(Fragment, null, RenderHelpers.renderList(item.tags, (item2, index2, __index, _cached): any => {
              return _cE("text", _uM({
                class: "tag-item",
                key: index2
              }), _tD(item2), 1 /* TEXT */)
    ...
    _cE("list-item", _uM({ class: "loading" }), [
...
const GenPagesTemplateLongListLongListPageStyles = [_uM([["list", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["backgroundColor", "#ffffff"]]))], ["list-item", _pS(_uM([["flexDirection", "row"], ["marginTop", 10], ["paddingTop", 10], ["paddingRight", 10], ["paddingBottom", 10], ["paddingLeft", 10]]))], ["list-item-icon", _pS(_uM([["position", "relative"]]))], ["list-item-icon-image", _pS(_uM([["width", 80], ["height", 80]]))], ["list-item-fill", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["marginLeft", 15]]))], ["description-text", _pS(_uM([["fontSize", 13], ["color", "#666666"], ["lineHeight", "19px"]]))], ["icon-star", _pS(_uM([["fontFamily", "UtsStarIcons"], ["fontSize", 16], ["fontStyle", "normal"], ["color", "#ffca3e"], ["letterSpacing", 3]]))], ["tag-list", _pS(_uM([["flexDirection", "row"], ["marginTop", 5]]))], ["tag-item", _pS(_uM([["fontSize", 12], ["backgroundColor", "#EFF9F0"], ["color", "#639069"], ["borderTopLeftRadius", 20], ["borderTopRightRadius", 20], ["borderBottomRightRadius", 20], ["borderBottomLeftRadius", 20], ["marginRight", 5], ["paddingTop", 2], ["paddingRight", 5], ["paddingBottom", 2], ["paddingLeft", 5]]))], ["update-date", _pS(_uM([["marginTop", 10]]))], ["update-date-text", _pS(_uM([["fontSize", 12], ["color", "#888888"]]))], ["update-date-value", _pS(_uM([["fontSize", 12], ["color", "#777777"], ["marginLeft", 5]]))], ["author", _pS(_uM([["fontSize", 12], ["color", "#008000"], ["marginLeft", "auto"]]))], ["loading", _pS(_uM([["paddingTop", 30], ["paddingRight", 30], ["paddingBottom", 30], ["paddingLeft", 30], ["alignItems", "center"]]))], ["flex-row", _pS(_uM([["flexDirection", "row"]]))], ["@FONT-FACE", _uM([["0", _uM([["fontFamily", "UtsStarIcons"], ["src", "url('/static/fonts/icon-star.ttf')"]])]])]])]
