type SwiperViewItem = { __$originalPosition?: UTSSourceMapPosition<"SwiperViewItem", "pages/template/swiper-list2/swiper-list2.uvue", 22, 6>;
  title : string,
}
