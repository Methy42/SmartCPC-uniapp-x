  ...
  type ListItem = { __$originalPosition?: UTSSourceMapPosition<"ListItem", "pages/template/swiper-vertical-video/swiper-vertical-video.uvue", 30, 8>; _id : string, content : string, src : string, poster_src : string }
  let page : number = 0,
