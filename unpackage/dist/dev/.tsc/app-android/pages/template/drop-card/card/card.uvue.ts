      ...
      touchend() {
        ...
        if (Math.floor(k) != 0) {
          ...
          cardTo(Math.floor(_x * -0.05), Math.floor(_y * -0.05), () => {
            cardTo(0, 0, () => {
              console.log('bounce', " at pages/template/drop-card/card/card.uvue:189")
              floating = false
            }, 30)
          })
        }
...
const GenPagesTemplateDropCardCardCardStyles = [_uM([["card", _pS(_uM([["width", "95%"], ["height", 0], ["position", "absolute"], ["top", 0], ["marginTop", 50], ["marginRight", 12], ["marginBottom", 0], ["marginLeft", 12], ["borderTopLeftRadius", 10], ["borderTopRightRadius", 10], ["borderBottomRightRadius", 10], ["borderBottomLeftRadius", 10], ["boxShadow", "0 0 5px rgba(0, 0, 0, 0.1)"], ["backgroundColor", "#FFFFFF"], ["transitionProperty", "marginTop"], ["transitionDuration", "300ms"], ["transitionTimingFunction", "ease-in"]]))], ["card-img", _pS(_uM([["width", "100%"], ["height", 0], ["borderTopLeftRadius", 10], ["borderTopRightRadius", 10], ["borderBottomRightRadius", 10], ["borderBottomLeftRadius", 10]]))], ["state", _pS(_uM([["top", 10], ["left", 10], ["width", "86%"], ["paddingTop", 4], ["paddingRight", 4], ["paddingBottom", 4], ["paddingLeft", 4], ["position", "absolute"], ["flexDirection", "row"], ["justifyContent", "space-between"]]))], ["state-icon", _pS(_uM([["width", 30], ["height", 30], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#FFFFFF"], ["borderRightColor", "#FFFFFF"], ["borderBottomColor", "#FFFFFF"], ["borderLeftColor", "#FFFFFF"], ["backgroundColor", "#FFFFFF"], ["paddingTop", 3], ["paddingRight", 3], ["paddingBottom", 3], ["paddingLeft", 3], ["borderTopLeftRadius", 100], ["borderTopRightRadius", 100], ["borderBottomRightRadius", 100], ["borderBottomLeftRadius", 100], ["boxShadow", "0 0 1px #EBEBEB"], ["opacity", 0]]))], ["@TRANSITION", _uM([["card", _uM([["property", "marginTop"], ["duration", "300ms"], ["timingFunction", "ease-in"]])]])]])]
