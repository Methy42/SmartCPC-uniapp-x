  ...
  type CoordsType = { __$originalPosition?: UTSSourceMapPosition<"CoordsType", "pages/template/calendar/calendar.uvue", 25, 8>;
    x : number;
    y : number;
    width : number;
    height : number;
  ...
  const __sfc__ = defineComponent({
    ...
    methods: {
      ...
      drawWeek(weeks : Array<Array<DateType>>, time : string) {
        ...
        ctx.update()
        console.log('diff time', Date.now() - start_time, " at pages/template/calendar/calendar.uvue:310");
...
const _cache = this.$.renderCache
  return _cE("scroll-view", _uM({
    ...
    _cE("view", _uM({ class: "root" }), [
      _cE("view", _uM({ class: "date" }), [
        _cE("text", _uM({ class: "date-text" }), _tD(_ctx.current_month), 1 /* TEXT */)
      ]),
      _cE("view", _uM({
        ref: "draw-header",
      ...
      _cE("view", null, _tD(_ctx.timeData.fullDate) + " " + _tD(_ctx.current_day), 1 /* TEXT */)
    ])
  ], 4 /* STYLE */)
}
const GenPagesTemplateCalendarCalendarStyles = [_uM([["root", _pS(_uM([["position", "relative"], ["paddingTop", 15], ["paddingRight", 15], ["paddingBottom", 15], ["paddingLeft", 15], ["backgroundColor", "#ffffff"]]))], ["calendar-header", _pS(_uM([["height", 30], ["marginBottom", 10]]))], ["date", _pS(_uM([["marginBottom", 10], ["marginLeft", 10]]))], ["date-text", _pS(_uM([["fontSize", 34], ["fontWeight", "bold"]]))], ["calendar-week", _pS(_uM([["height", 350], ["marginTop", 2], ["marginRight", 0], ["marginBottom", 2], ["marginLeft", 0]]))], ["btn-group", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["justifyContent", "space-between"], ["marginTop", 20], ["marginRight", 0], ["marginBottom", 20], ["marginLeft", 0]]))]])]
