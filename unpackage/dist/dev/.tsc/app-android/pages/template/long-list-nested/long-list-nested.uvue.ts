import longPage from '../long-list/long-list-page.uvue';
  ...
  type SwiperTabsItem = { __$originalPosition?: UTSSourceMapPosition<"SwiperTabsItem", "pages/template/long-list-nested/long-list-nested.uvue", 35, 8>;
    x : number,
    w : number
  }

  type SwiperViewItem = { __$originalPosition?: UTSSourceMapPosition<"SwiperViewItem", "pages/template/long-list-nested/long-list-nested.uvue", 40, 8>;
    type : string,
    name : string,
    id : string,
    preload : boolean,
