type SwiperTabsItem = { __$originalPosition?: UTSSourceMapPosition<"SwiperTabsItem", "pages/template/swiper-list/swiper-list.uvue", 24, 6>;
  x : number,
  w : number
}

type SwiperViewItem = { __$originalPosition?: UTSSourceMapPosition<"SwiperViewItem", "pages/template/swiper-list/swiper-list.uvue", 29, 6>;
  title : string,
}
...
const GenPagesTemplateSwiperListSwiperListStyles = [_uM([["flex-row", _pS(_uM([["flexDirection", "row"], ["alignSelf", "flex-start"]]))], ["swiper-list", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["swiper-tabs", _pS(_uM([["backgroundColor", "#ffffff"]]))], ["swiper-tabs-item", _pS(_uM([["color", "#555555"], ["fontSize", 16], ["paddingTop", 12], ["paddingRight", 25], ["paddingBottom", 12], ["paddingLeft", 25], ["whiteSpace", "nowrap"]]))], ["swiper-tabs-item-active", _pS(_uM([["color", "#007AFF"]]))], ["swiper-tabs-indicator", _pS(_uM([["width", 1], ["height", 2], ["backgroundColor", "#007AFF"]]))], ["swiper-view", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["swiper-item", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["alignItems", "center"], ["justifyContent", "center"]]))], ["swiper-item-text", _pS(_uM([["fontSize", 72], ["fontWeight", "bold"]]))]])]
