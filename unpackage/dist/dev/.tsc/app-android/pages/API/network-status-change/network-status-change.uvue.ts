...
const _component_page_head = resolveEasyComponent("page-head",_easycom_page_head)
  ...
  return _cE(Fragment, null, [
    _cV(_component_page_head, _uM({ title: "networkStatusChange" })),
    _cE("view", _uM({ class: "uni-list-cell-padding status-box" }), [
      _cE("text", _uM({ class: "uni-title-text" }), "网络状态"),
      _cE("view", _uM({ class: "uni-row uni-common-mt" }), [
        _cE("text", _uM({ class: "uni-hello-text" }), "是否连接："),
        _cE("text", null, _tD(unref(isConnected) ? '已连接' : '未连接'), 1 /* TEXT */)
      ]),
      _cE("view", _uM({ class: "uni-row uni-common-mt" }), [
        _cE("text", _uM({ class: "uni-hello-text" }), "网络类型："),
        _cE("text", null, _tD(unref(networkType)), 1 /* TEXT */)
      ]),
      _cE("view", _uM({ class: "uni-row uni-common-mt" }), [
        _cE("text", _uM({ class: "uni-hello-text" }), "监听状态："),
        _cE("text", null, _tD(unref(listenStatus)), 1 /* TEXT */)
      ])
    ]),
    _cE("view", _uM({ class: "uni-list-cell-padding uni-common-mt" }), [
      _cE("button", _uM({
        type: "primary",
        onClick: startListen
      }), "开始监听"),
...
const GenPagesAPINetworkStatusChangeNetworkStatusChangeStyles = [_uM([["status-box", _pS(_uM([["backgroundColor", "#FFFFFF"], ["marginTop", 0], ["marginRight", 20], ["marginBottom", 0], ["marginLeft", 20]]))]])]
