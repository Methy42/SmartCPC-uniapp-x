  ...
  type IconItemType = { __$originalPosition?: UTSSourceMapPosition<"IconItemType", "pages/API/toast/toast.uvue", 55, 8>;
    value : "success" | "error" | "fail" | "exception" | "loading" | "none";
    name : string
  }
  type PositionItemType = { __$originalPosition?: UTSSourceMapPosition<"PositionItemType", "pages/API/toast/toast.uvue", 59, 8>;
...
function GenPagesAPIToastToastRender(this: InstanceType<typeof __sfc__>): any | null {
const _ctx = this
...
const _component_slider = resolveComponent("slider")
  ...
  return _cE("scroll-view", _uM({
    ...
    _cE("view", _uM({ class: "uni-padding-wrap" }), [
      _cE("view", _uM({ class: "uni-padding-wrap" }), [
        _cE("text", _uM({ class: "uni-title-text uni-common-mb" }), "设置icon")
      ]),
      _cE("view", _uM({ class: "uni-list uni-common-pl" }), [
        _cV(_component_radio_group, _uM({ onChange: _ctx.radioChangeIcon }), _uM({
          default: withSlotCtx((): any[] => [
            _cE(Fragment, null, RenderHelpers.renderList(_ctx.icon_enum, (icon, index, __index, _cached): any => {
              return _cV(_component_radio, _uM({
                class: _nC(["uni-list-cell uni-list-cell-pd radio-icon", index < _ctx.icon_enum.length - 1 ? 'uni-list-cell-line' : '']),
                key: icon.value,
                value: icon.value,
                checked: index === _ctx.icon_current
              }), _uM({
                default: withSlotCtx((): any[] => [_tD(icon.name)]),
                _: 2 /* DYNAMIC */
      ...
      _cE("view", _uM({ class: "uni-list-cell uni-list-cell-padding" }), [
        _cE("view", _uM({ class: "uni-list-cell-db" }), "是否显示自定义图标"),
      ...
      _cE("view", _uM({ class: "uni-list-cell uni-list-cell-padding" }), [
        _cE("view", _uM({ class: "uni-list-cell-db" }), "是否显示透明蒙层-屏蔽点击事件"),
        _cV(_component_switch, _uM({
          checked: _ctx.maskSelect,
          onChange: _ctx.change_mask_boolean
        }), null, 8 /* PROPS */, ["checked", "onChange"])
      ]),
      _cE("view", _uM({ class: "uni-title uni-list-cell-padding" }), "提示的延迟时间，默认：1500（单位毫秒）"),
      _cE("view", _uM({ class: "uni-list-cell-padding" }), [
      ...
      _cE("view", _uM({ class: "uni-padding-wrap uni-common-mt" }), [
        _cE("text", _uM({ class: "uni-title-text uni-common-mb" }), " 设置position，仅App生效 ")
      ]),
      _cE("view", _uM({ class: "uni-list uni-common-pl" }), [
        _cV(_component_radio_group, _uM({ onChange: _ctx.radioChangePosition }), _uM({
          default: withSlotCtx((): any[] => [
            _cE(Fragment, null, RenderHelpers.renderList(_ctx.position_enum, (position, index, __index, _cached): any => {
              return _cV(_component_radio, _uM({
                class: _nC(["uni-list-cell uni-list-cell-pd radio-position", index < _ctx.position_enum.length - 1 ? 'uni-list-cell-line' : '']),
                key: position.value,
                value: position.value,
                checked: index === _ctx.position_current
              }), _uM({
                default: withSlotCtx((): any[] => [_tD(position.name)]),
                _: 2 /* DYNAMIC */
              }), 1032 /* PROPS, DYNAMIC_SLOTS */, ["class", "value", "checked"])
            }), 128 /* KEYED_FRAGMENT */)
          ]),
      ...
      _cE("text", null, _tD(_ctx.exeRet), 1 /* TEXT */)
    ])
  ], 4 /* STYLE */)
}
const GenPagesAPIToastToastStyles = []
