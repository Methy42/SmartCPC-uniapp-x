  ...
  type ProviderItem = { __$originalPosition?: UTSSourceMapPosition<"ProviderItem", "pages/API/provider/provider.uvue", 24, 8>;
    service : string,
    name : string,
    provider : string[],
