  ...
  const duration = 2000
  const methodMap = {__$originalPosition: new UTSSourceMapPosition("methodMap", "pages/API/request/request.uvue", 104, 9),
              ...
              uni.getFileSystemManager().readFile({
                ...
                success: (res) => {
                  ...
                  this.task = uni.request<ArrayBuffer>({
                    ...
                    responseType: 'arraybuffer',
                    success: (res) => {
                      console.log("at pages/API/request/request.uvue:301")
                      if (res.data != null) {
                        uni.showToast({
                          title: '请求成功',
                          icon: 'success',
    ...
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({
        ...
        _cE("view", _uM({
          ...
          _cE("button", _uM({
            style: _nS(_uM({"padding":"5px","margin-right":"10px"})),
            type: "primary",
            size: "mini",
      ...
      _cE("view", _uM({
        ...
        _cE("view", _uM({
          ...
          _cE(Fragment, null, RenderHelpers.renderList(_ctx.errorCodeUrls, (item, index, __index, _cached): any => {
            ...
            }), _tD(item), 13 /* TEXT, STYLE, PROPS */, ["onClick"])
          }), 128 /* KEYED_FRAGMENT */)
        ], 4 /* STYLE */)
      ], 4 /* STYLE */),
      _cE("view", _uM({
        ...
        _cE("view", _uM({
          ...
          _cE(Fragment, null, RenderHelpers.renderList(_ctx.headerUrls, (item, index, __index, _cached): any => {
            return _cE("button", _uM({
              style: _nS(_uM({"padding":"5px"})),
              type: "primary",
              size: "mini",
      ...
      _cE("view", _uM({
        ...
        _cE("view", _uM({
          ...
          _cE(Fragment, null, RenderHelpers.renderList(_ctx.contentTypeUrls, (item, index, __index, _cached): any => {
            return _cE("button", _uM({
              style: _nS(_uM({"padding":"5px"})),
              type: "primary",
              size: "mini",
      ...
      _cE("view", _uM({
        ...
        _cE("view", _uM({
          ...
          _cE(Fragment, null, RenderHelpers.renderList(_ctx.postUrls, (item, index, __index, _cached): any => {
            return _cE("button", _uM({
              style: _nS(_uM({"padding":"5px"})),
              type: "primary",
              size: "mini",
      ...
      _cE("view", _uM({
        ...
        _cE("view", _uM({
          ...
          _cE("button", _uM({
            ...
            type: "primary",
            size: "mini",
            onClick: () => {_ctx.sendArrayBuffer(false)}
          }), "请求body为ArrayBuffer，response也为ArrayBuffer", 12 /* STYLE, PROPS */, ["onClick"]),
          _cE("button", _uM({
            style: _nS(_uM({"padding":"5px"})),
            type: "primary",
            size: "mini",
            onClick: () => {_ctx.sendArrayBuffer(true)}
          }), "请求response为ArrayBuffer", 12 /* STYLE, PROPS */, ["onClick"])
        ], 4 /* STYLE */)
      ], 4 /* STYLE */),
      _cE("view", _uM({
        style: _nS(_uM({"padding":"20px"}))
        ...
        _cE("button", _uM({
          type: "primary",
          onClick: _ctx.sendChunkRequest
        }), "流式请求", 8 /* PROPS */, ["onClick"])
      ], 4 /* STYLE */),
      _cE("view", _uM({ class: "uni-common-pb" })),
      _cE("view", _uM({ class: "uni-common-pb" }))
    ], 4 /* STYLE */)
...
const GenPagesAPIRequestRequestStyles = [_uM([["uni-textarea", _pS(_uM([["paddingTop", 9], ["paddingRight", 9], ["paddingBottom", 9], ["paddingLeft", 9], ["fontSize", 14]]))]])]
