...
const _cache = this.$.renderCache
  return _cE("scroll-view", _uM({ class: "page-scroll-view" }), [
    _cE("view", _uM({ class: "box" }), [
      ...
      _cE("view", null, [
        _cE("view", _uM({ class: "uni-btn" }), "收到的消息："),
        _cE("view", _uM({ class: "uni-btn" }), [
          _cE(Fragment, null, RenderHelpers.renderList(_ctx.log, (item, index, __index, _cached): any => {
            return _cE("view", _uM({ key: index }), _tD(item), 1 /* TEXT */)
          }), 128 /* KEYED_FRAGMENT */)
        ]),
        _cE("button", _uM({
          class: "uni-btn",
        ...
        _cE("view", _uM({ class: "uni-btn" }), [
          ...
          _cE("text", null, _tD(JSON.stringify(_ctx.objArg)), 1 /* TEXT */)
        ]),
        _cE("button", _uM({
          class: "uni-btn",
...
const GenPagesAPIEventBusEventBusStyles = [_uM([["box", _pS(_uM([["paddingTop", 10], ["paddingRight", 10], ["paddingBottom", 10], ["paddingLeft", 10]]))]])]
