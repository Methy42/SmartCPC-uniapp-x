  ...
  const __sfc__ = defineComponent({
    ...
    methods: {
      ...
      complexMock() {
        this.key = 'key_' + Math.random()
        let jsonObj = {__$originalPosition: new UTSSourceMapPosition("jsonObj", "pages/API/storage/storage.uvue", 185, 13),
          name: '张三',
          age: 12,
          classMate: [
            {
    ...
    _cE("view", null, [
      ...
      _cE("view", _uM({ class: "uni-common-mt" }), [
        _cE("view", _uM({ class: "uni-list" }), [
          _cE("view", _uM({ class: "uni-list-cell uni-list-cell-line" }), [
            _cE("view", _uM({ class: "uni-list-cell-left" }), [
              _cE("view", _uM({ class: "uni-label" }), "key")
            ]),
          ...
          _cE("view", _uM({ class: "uni-list-cell" }), [
            _cE("view", _uM({ class: "uni-list-cell-left" }), [
              _cE("view", _uM({ class: "uni-label" }), "value")
            ]),
            _cE("view", _uM({ class: "uni-list-cell-db" }), [
              _cE("input", _uM({
                class: "uni-input",
        ...
        _cE("view", _uM({ class: "uni-padding-wrap" }), [
          ...
          _cE("text", _uM({ class: "uni-list-cell-db-text" }), _tD(_ctx.storageInfo), 1 /* TEXT */),
          _cE("view", _uM({ class: "uni-flex uni-row" }), [
            _cE("button", _uM({
              type: "default",
              style: _nS(_uM({"width":"50%"})),
