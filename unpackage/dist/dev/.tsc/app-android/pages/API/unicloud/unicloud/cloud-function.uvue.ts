    ...
    _cE("view", null, [
      ...
      _cE("view", _uM({ class: "uni-padding-wrap uni-common-mt" }), [
        _cE("view", _uM({ class: "uni-btn-v uni-common-mt" }), [
          ...
          _cE("view", null, [
            _cE("text", _uM({ class: "tips" }), "安全网络相关功能需要打包自定义基座方可正常使用")
          ])
        ])
      ])
    ])
...
const GenPagesAPIUnicloudUnicloudCloudFunctionStyles = [_uM([["tips", _pS(_uM([["color", "#999999"], ["fontSize", 12], ["paddingTop", 10], ["paddingRight", 0], ["paddingBottom", 10], ["paddingLeft", 0]]))]])]
