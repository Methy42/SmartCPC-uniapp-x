...
const _component_page_head = resolveEasyComponent("page-head",_easycom_page_head)
  ...
  return _cE("scroll-view", _uM({
    ...
    _cV(_component_page_head, _uM({ title: "权限申请监听" })),
    _cE("view", _uM({
      class: "permission-alert",
      id: "permission-alert",
      style: _nS(_uM({'transform':_ctx.isPermissionAlertShow ? 'translateY(0)':'translateY(-110px)'}))
    }), [
      _cE("text", _uM({
        style: _nS(_uM({"font-size":"20px","margin-bottom":"10px","margin-top":"5px"}))
      }), "访问日历权限申请说明：", 4 /* STYLE */),
      _cE("text", _uM({
        style: _nS(_uM({"color":"darkgray"}))
...
const GenPagesAPICreateRequestPermissionListenerCreateRequestPermissionListenerStyles = [_uM([["permission-alert", _pS(_uM([["width", "90%"], ["height", 100], ["marginTop", 10], ["marginRight", "5%"], ["marginBottom", 10], ["marginLeft", "5%"], ["position", "absolute"], ["top", 0], ["zIndex", 3], ["borderTopLeftRadius", 5], ["borderTopRightRadius", 5], ["borderBottomRightRadius", 5], ["borderBottomLeftRadius", 5], ["transitionProperty", "transform"], ["transitionDuration", "200ms"], ["backgroundColor", "#FFFFFF"], ["paddingTop", 10], ["paddingRight", 10], ["paddingBottom", 10], ["paddingLeft", 10]]))], ["@TRANSITION", _uM([["permission-alert", _uM([["property", "transform"], ["duration", "200ms"]])]])]])]
