  ...
  return _cE("scroll-view", _uM({ class: "page-scroll-view" }), [
    _cE("view", _uM({
      ...
      _cE("view", _uM({
        ...
        _cE("view", _uM({ class: "rect rect1" })),
        _cE("view", _uM({ class: "rect rect2" }))
      ]),
      _cE("view", _uM({ class: "rect-info-1-2" }), [
        _cE(Fragment, null, RenderHelpers.renderList(_ctx.nodeInfoList, (nodeInfo, index, __index, _cached): any => {
          return _cE("view", _uM({
            class: "rect-info",
            key: index
          }), [
            _cE("view", _uM({ class: "node-info-item" }), [
              ...
              _cE("text", _uM({ class: "node-info-item-v" }), _tD(nodeInfo.left), 1 /* TEXT */)
            ]),
            _cE("view", _uM({ class: "node-info-item" }), [
              _cE("text", _uM({ class: "node-info-item-k" }), "top: "),
              _cE("text", _uM({ class: "node-info-item-v" }), _tD(nodeInfo.top), 1 /* TEXT */)
            ]),
            _cE("view", _uM({ class: "node-info-item" }), [
              _cE("text", _uM({ class: "node-info-item-k" }), "right: "),
              _cE("text", _uM({ class: "node-info-item-v" }), _tD(nodeInfo.right), 1 /* TEXT */)
            ]),
            _cE("view", _uM({ class: "node-info-item" }), [
              _cE("text", _uM({ class: "node-info-item-k" }), "bottom: "),
              _cE("text", _uM({ class: "node-info-item-v" }), _tD(nodeInfo.bottom), 1 /* TEXT */)
            ]),
            _cE("view", _uM({ class: "node-info-item" }), [
              _cE("text", _uM({ class: "node-info-item-k" }), "width: "),
              _cE("text", _uM({ class: "node-info-item-v" }), _tD(nodeInfo.width), 1 /* TEXT */)
            ]),
            _cE("view", _uM({ class: "node-info-item" }), [
              _cE("text", _uM({ class: "node-info-item-k" }), "height: "),
              _cE("text", _uM({ class: "node-info-item-v" }), _tD(nodeInfo.height), 1 /* TEXT */)
            ])
          ])
        }), 128 /* KEYED_FRAGMENT */)
      ]),
      _cV(_component_node_child, _uM({ class: "node-child" })),
      _cE("text", null, "子组件多根节点"),
      _cV(_component_multi_child, _uM({
        ref: "multi-child",
        id: "multi-child"
      }), null, 512 /* NEED_PATCH */),
      _cE("text", null, "子组件多根节点(仅测试，用于验证查询是否超出范围)"),
      _cV(_component_multi_child, _uM({ id: "multi-child-2" })),
      _cE("view", null, [
        _cE("text", null, "测试.fields"),
        _cE("text", null, _tD(_ctx.fieldsResultContainNode), 1 /* TEXT */)
      ]),
      _cE("view", null, [
        _cE("text", null, "测试.node"),
        _cE("text", null, _tD(_ctx.nodeResultContainNode), 1 /* TEXT */)
      ]),
      _cE("canvas", _uM({ id: "canvas1" }))
    ])
  ])
}
const GenPagesAPICreateSelectorQueryCreateSelectorQueryStyles = [_uM([["page", _pS(_uM([["paddingTop", 15], ["paddingRight", 15], ["paddingBottom", 15], ["paddingLeft", 15]]))], ["btn", _pS(_uM([["marginTop", 15]]))], ["rect-1-2", _pS(_uM([["flexDirection", "row"], ["marginTop", 15]]))], ["rect", _pS(_uM([["width", 150], ["height", 100]]))], ["rect1", _pS(_uM([["backgroundColor", "#1E90FF"]]))], ["rect2", _pS(_uM([["marginLeft", "auto"], ["backgroundColor", "#2E8B57"]]))], ["rect-info-1-2", _pS(_uM([["flexDirection", "row"], ["marginTop", 15]]))], ["rect-info", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["flexDirection", "column"]]))], ["node-info-item", _pS(_uM([["flexDirection", "row"]]))], ["node-info-item-k", _pS(_uM([["width", 72], ["lineHeight", 2]]))], ["node-info-item-v", _pS(_uM([["fontWeight", "bold"], ["lineHeight", 2]]))]])]
