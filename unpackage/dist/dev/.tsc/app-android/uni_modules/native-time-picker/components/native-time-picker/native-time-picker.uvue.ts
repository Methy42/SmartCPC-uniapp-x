...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "def-picker" }), [
    _cE("native-view", _uM({
...
const GenUniModulesNativeTimePickerComponentsNativeTimePickerNativeTimePickerStyles = [_uM([["def-picker", _pS(_uM([["minWidth", 300], ["minHeight", 380], ["maxWidth", 400], ["maxHeight", 400]]))]])]
