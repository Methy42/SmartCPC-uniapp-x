...
const _component_LoadingCircle = resolveComponent("LoadingCircle")
  ...
  return _cE("view", _uM({
    class: _nC(["uni-loading-main", _uM({'load-inline':_ctx.$slots['default'] == null})])
  }), [
    isTrue(_ctx.loading)
      ? _cE(Fragment, _uM({ key: 0 }), [
          ...
          _ctx.$slots['default'] == null
            ? _cE(Fragment, _uM({ key: 0 }), [
                _cV(_component_LoadingCircle, _uM({
                  speed: 16,
                  size: _ctx.loadWidth,
                  color: _ctx.color
            ...
            : _cE("view", _uM({
                ...
                style: _nS(_uM({backgroundColor:_ctx.background}))
              }), [
                _cV(_component_LoadingCircle, _uM({
                  speed: 16,
                  size: _ctx.loadWidth,
...
const GenUniModulesUniLoadingComponentsUniLoadingUniLoadingStyles = [_uM([["uni-loading-main", _uM([["", _uM([["position", "relative"]])], [".load-inline", _uM([["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"]])]])], ["block-text", _pS(_uM([["marginTop", 8], ["fontSize", 14]]))], ["inline-text", _pS(_uM([["marginLeft", 8], ["fontSize", 14]]))], ["uni-loading-mask", _pS(_uM([["position", "absolute"], ["width", "100%"], ["height", "100%"], ["top", 0], ["left", 0], ["display", "flex"], ["justifyContent", "center"], ["alignItems", "center"], ["backgroundColor", "rgba(0,0,0,0.3)"], ["zIndex", 2]]))], ["uni-load", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["justifyContent", "center"], ["alignItems", "center"]]))], ["load-text", _pS(_uM([["fontSize", 14], ["color", "#ffffff"], ["marginTop", 12]]))], ["image", _uM([[".uni-load ", _uM([["width", "100%"], ["height", "100%"]])]])], ["load-image", _pS(_uM([["width", "100%"], ["height", "100%"]]))], ["load-ani", _pS(_uM([["transitionProperty", "transform"], ["transitionDuration", "0.1s"], ["transitionTimingFunction", "linear"], ["transform", "rotate(0deg)"]]))], ["@TRANSITION", _uM([["load-ani", _uM([["property", "transform"], ["duration", "0.1s"], ["timingFunction", "linear"]])]])]])]
